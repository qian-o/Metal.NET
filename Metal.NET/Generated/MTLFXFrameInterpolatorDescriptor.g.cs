...
public readonly struct MTLFXFrameInterpolatorDescriptor
{
    ...
    {
        var __result = ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptor_Selectors.newFrameInterpolator_, pDevice.NativePtr);
    ...
    {
        var __result = ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptor_Selectors.newFrameInterpolator_pCompiler_, pDevice.NativePtr, pCompiler.NativePtr);
        return new MTLFXFrameInterpolator(__result);
    }
