...
public partial class NSString(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<NSString>
{
    ...
    public nint InitWithUTF8String(nint nullTerminatedCString)
    {
        return ObjectiveC.MsgSendNInt(NativePtr, NSStringBindings.InitWithUTF8String, nullTerminatedCString);
    }

    public nint InitWithString(NSString aString)
    {
        return ObjectiveC.MsgSendNInt(NativePtr, NSStringBindings.InitWithString, aString.NativePtr);
    }

    public nint InitWithFormat(NSString format)
    {
        return ObjectiveC.MsgSendNInt(NativePtr, NSStringBindings.InitWithFormat, format.NativePtr);
    }

    public nint InitWithFormat(NSString format, NSObject locale)
    {
        return ObjectiveC.MsgSendNInt(NativePtr, NSStringBindings.InitWithFormatLocale, format.NativePtr, locale.NativePtr);
    }

    public nint InitWithValidatedFormat(NSString format, NSString validFormatSpecifiers, out NSError error)
    {
        nint result = ObjectiveC.MsgSendNInt(NativePtr, NSStringBindings.InitWithValidatedFormatValidFormatSpecifiersError, format.NativePtr, validFormatSpecifiers.NativePtr, out nint errorPtr);
    ...
    public nint InitWithValidatedFormat(NSString format, NSString validFormatSpecifiers, NSObject locale, out NSError error)
    {
        nint result = ObjectiveC.MsgSendNInt(NativePtr, NSStringBindings.InitWithValidatedFormatValidFormatSpecifiersLocaleError, format.NativePtr, validFormatSpecifiers.NativePtr, locale.NativePtr, out nint errorPtr);
    ...
    public NSObject InitWithContentsOfFile(NSString path)
    {
        nint nativePtr = ObjectiveC.MsgSendNInt(NativePtr, NSStringBindings.InitWithContentsOfFile, path.NativePtr);
    ...
    {
        nint nativePtr = ObjectiveC.MsgSendNInt(NativePtr, NSStringBindings.InitWithContentsOfURL, url.NativePtr);
    ...
    public NSObject InitWithCStringNoCopy(nint bytes, nuint length, bool freeBuffer)
    {
        nint nativePtr = ObjectiveC.MsgSendNInt(NativePtr, NSStringBindings.InitWithCStringNoCopyLengthFreeWhenDone, bytes, length, freeBuffer);

        return new(nativePtr, NativeObjectOwnership.Owned);
    }

    public NSObject InitWithCString(nint bytes, nuint length)
    {
        nint nativePtr = ObjectiveC.MsgSendNInt(NativePtr, NSStringBindings.InitWithCStringLength, bytes, length);

        return new(nativePtr, NativeObjectOwnership.Owned);
    }

    public NSObject InitWithCString(nint bytes)
    {
        nint nativePtr = ObjectiveC.MsgSendNInt(NativePtr, NSStringBindings.InitWithCString, bytes);
