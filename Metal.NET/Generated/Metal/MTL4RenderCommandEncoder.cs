...
public partial class MTL4RenderCommandEncoder(nint nativePtr, NativeObjectOwnership ownership) : MTL4CommandEncoder(nativePtr, ownership), INativeObject<MTL4RenderCommandEncoder>
{
    ...
    public unsafe void SetViewports(MTLViewport[] viewports)
    {
        ...
        {
            ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.SetViewportsCount, (nint)pViewports, (nuint)viewports.Length);
        }
    }

    public void SetVertexAmplificationCount(nuint count, MTLVertexAmplificationViewMapping viewMappings)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.SetVertexAmplificationCountViewMappings, count, viewMappings);
    }
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.SetDepthBiasSlopeScaleClamp, depthBias, slopeScale, clamp);
    }

    public void SetDepthTestMinBound(float minBound, float maxBound)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.SetDepthTestMinBoundMaxBound, minBound, maxBound);
    }
    ...
    public unsafe void SetScissorRects(MTLScissorRect[] scissorRects)
    {
        ...
        {
            ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.SetScissorRectsCount, (nint)pScissorRects, (nuint)scissorRects.Length);
        }
    }
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.SetBlendColorRedGreenBlueAlpha, red, green, blue, alpha);
    }
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.SetVisibilityResultModeOffset, (nuint)mode, offset);
    }

    public void SetColorStoreAction(MTLStoreAction storeAction, nuint colorAttachmentIndex)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.SetColorStoreActionAtIndex, (nuint)storeAction, colorAttachmentIndex);
    }
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.DrawPrimitivesVertexStartVertexCount, (nuint)primitiveType, vertexStart, vertexCount);
    }
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.ExecuteCommandsInBufferWithRange, indirectCommandBuffer.NativePtr, executionRange);
    }
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.SetObjectThreadgroupMemoryLengthAtIndex, length, index);
    }
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.DrawMeshThreadsThreadsPerObjectThreadgroupThreadsPerMeshThreadgroup, threadsPerGrid, threadsPerObjectThreadgroup, threadsPerMeshThreadgroup);
    }
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.SetThreadgroupMemoryLengthOffsetAtIndex, length, offset, index);
    }

    public void SetArgumentTable(MTL4ArgumentTable argumentTable, MTLRenderStages stages)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.SetArgumentTableAtStages, argumentTable.NativePtr, (nuint)stages);
    }
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTL4RenderCommandEncoderBindings.WriteTimestampWithGranularityAfterStageIntoHeapAtIndex, (nint)granularity, (nuint)stage, counterHeap.NativePtr, index);
    }
}
...
file static class MTL4RenderCommandEncoderBindings
{
    ...
    public static readonly Selector SetArgumentTableAtStages = "setArgumentTable:atStages:";
    ...
    public static readonly Selector WriteTimestampWithGranularityAfterStageIntoHeapAtIndex = "writeTimestampWithGranularity:afterStage:intoHeap:atIndex:";
}
