...
public class MTLFXFrameInterpolatorBase(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLFXFrameInterpolatorBase>
{
    ...
    /// <summary>The ratio between width and height of the screen.</summary>
    ...
    /// <summary>The color texture that this frame interpolator evaluates.</summary>
    ...
    /// <summary>The pixel format of the input color texture for this frame interpolator.</summary>
    public MTLPixelFormat ColorTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXFrameInterpolatorBaseBindings.ColorTextureFormat);
    }

    /// <summary>The minimal texture usage options that your app’s input color texture needs in order to support this frame interpolator.</summary>
    ...
    /// <summary>The length of the time interval, in seconds, between time of current and previous frame.</summary>
    ...
    /// <summary>The depth texture this frame interpolator evaluates.</summary>
    ...
    /// <summary>The pixel format of the input depth texture for this frame interpolator.</summary>
    public MTLPixelFormat DepthTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXFrameInterpolatorBaseBindings.DepthTextureFormat);
    }

    /// <summary>The minimal texture usage options that your app’s input depth texture needs in order to support this frame interpolator.</summary>
    ...
    /// <summary>The far plane distance that corresponds to the frustrum that renders the scene into the color buffer.</summary>
    ...
    /// <summary>An optional fence that this frame interpolator waits for and updates.</summary>
    ...
    /// <summary>The vertical field of view angle, in degrees, of the camera that renders the scene into the color buffer.</summary>
    ...
    /// <summary>The height, in pixels, of the input color texture for the frame interpolator.</summary>
    public nuint InputHeight
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLFXFrameInterpolatorBaseBindings.InputHeight);
    }

    /// <summary>The width, in pixels, of the input color texture for the frame interpolator.</summary>
    ...
    /// <summary>A Boolean value that controls whether this frame interpolator interprets the color texture to include your game’s custom UI.</summary>
    ...
    /// <summary>The motion texture this frame interpolator evaluates.</summary>
    ...
    /// <summary>The pixel format of the input motion texture for this frame interpolator.</summary>
    public MTLPixelFormat MotionTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXFrameInterpolatorBaseBindings.MotionTextureFormat);
    }

    /// <summary>The minimal texture usage options that your app’s input motion texture needs in order to support this frame interpolator.</summary>
    ...
    /// <summary>The horizontal scale factor the frame interpolator applies to the input motion texture.</summary>
    ...
    /// <summary>The vertical scale factor the frame interpolator applies to the input motion texture.</summary>
    ...
    /// <summary>The near plane distance that corresponds to the frustrum that renders the scene into the color buffer.</summary>
    ...
    /// <summary>The output texture into which this frame interpolator writes its output.</summary>
    ...
    /// <summary>The pixel format of the output color texture for this frame interpolator.</summary>
    public MTLPixelFormat OutputTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXFrameInterpolatorBaseBindings.OutputTextureFormat);
    }

    /// <summary>The minimal texture usage options that your app’s output color texture needs in order to support this frame interpolator.</summary>
    ...
    /// <summary>The previous color texture for this frame interpolator during the last call to encode work into a command buffer.</summary>
    ...
    /// <summary>An optional texture containing your game’s custom UI that this frame interpolator evaluates.</summary>
    public MTLTexture UiTexture
    {
        get => GetProperty(ref field, MTLFXFrameInterpolatorBaseBindings.UiTexture);
    }

    /// <summary>The pixel format of the input UI texture for the frame interpolator.</summary>
    ...
    /// <summary>The minimal texture usage options that your app’s input UI texture needs in order to support this frame interpolator.</summary>
