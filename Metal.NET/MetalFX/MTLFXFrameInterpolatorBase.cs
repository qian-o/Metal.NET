...
public class MTLFXFrameInterpolatorBase(nint nativePtr, bool ownsReference, bool allowGCRelease) : NativeObject(nativePtr, ownsReference, allowGCRelease), INativeObject<MTLFXFrameInterpolatorBase>
{
    public static MTLFXFrameInterpolatorBase Null { get; } = new(0, false, false);

    public static MTLFXFrameInterpolatorBase Create(nint nativePtr, bool ownsReference, bool allowGCRelease) => new(nativePtr, ownsReference, allowGCRelease);
