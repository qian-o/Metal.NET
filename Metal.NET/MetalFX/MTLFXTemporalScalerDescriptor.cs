...
/// <summary>A set of properties that configure a temporal scaling effect, and a factory method that creates the effect.</summary>
public class MTLFXTemporalScalerDescriptor(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLFXTemporalScalerDescriptor>
{
    ...
    /// <summary>The width of the input color texture for the temporal scaler you create with this descriptor.</summary>
    ...
    /// <summary>The height of the input color texture for the temporal scaler you create with this descriptor.</summary>
    ...
    /// <summary>A Boolean value that indicates whether the temporal scaler you create with this descriptor uses dynamic resolution.</summary>
    ...
    /// <summary>The smallest scale factor the temporal scaler you create with this descriptor can use to generate output textures.</summary>
    ...
    /// <summary>The largest scale factor the temporal scaler you create with this descriptor can use to generate output textures.</summary>
    ...
    /// <summary>The pixel format of the input color texture for the temporal scaler you create with this descriptor.</summary>
    ...
    /// <summary>The pixel format of the input motion texture for the temporal scaler you create with this descriptor.</summary>
    ...
    /// <summary>The pixel format of the input depth texture for the temporal scaler you create with this descriptor.</summary>
    ...
    /// <summary>A Boolean value that indicates whether a temporal scaler you create with the descriptor applies a reactive mask.</summary>
    ...
    /// <summary>The pixel format of the reactive mask input texture for a temporal scaler you create with the descriptor.</summary>
    ...
    /// <summary>The width of the output color texture for the temporal scaler you create with this descriptor.</summary>
    ...
    /// <summary>The height of the output color texture for the temporal scaler you create with this descriptor.</summary>
    ...
    /// <summary>The pixel format of the output color texture for the temporal scaler you create with this descriptor.</summary>
    ...
    /// <summary>Returns a Boolean value that indicates whether the temporal scaler works with a GPU.</summary>
    ...
    /// <summary>Creates a temporal scaler instance from this descriptor’s current property values.</summary>
    ...
    /// <summary>Queries whether a Metal device supports temporal scaling compatible with Metal 4.</summary>
