...
public class MTLFXTemporalScalerDescriptor : IDisposable
{
    ...
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetColorTextureFormat, (nint)(uint)format);
    }

    public void SetDepthTextureFormat(MTLPixelFormat format)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetDepthTextureFormat, (nint)(uint)format);
    }

    public void SetMotionTextureFormat(MTLPixelFormat format)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetMotionTextureFormat, (nint)(uint)format);
    }

    public void SetOutputTextureFormat(MTLPixelFormat format)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetOutputTextureFormat, (nint)(uint)format);
    }

    public void SetInputWidth(uint width)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetInputWidth, (nint)width);
    }

    public void SetInputHeight(uint height)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetInputHeight, (nint)height);
    }

    public void SetOutputWidth(uint width)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetOutputWidth, (nint)width);
    }

    public void SetOutputHeight(uint height)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetOutputHeight, (nint)height);
    }

    public void SetAutoExposureEnabled(Bool8 enabled)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetAutoExposureEnabled, (nint)enabled.Value);
    }

    public void SetInputContentPropertiesEnabled(Bool8 enabled)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetInputContentPropertiesEnabled, (nint)enabled.Value);
    }

    public void SetRequiresSynchronousInitialization(Bool8 requiresSynchronousInitialization)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetRequiresSynchronousInitialization, (nint)requiresSynchronousInitialization.Value);
    }

    public void SetReactiveMaskTextureEnabled(Bool8 enabled)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetReactiveMaskTextureEnabled, (nint)enabled.Value);
    }

    public void SetReactiveMaskTextureFormat(MTLPixelFormat pixelFormat)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetReactiveMaskTextureFormat, (nint)(uint)pixelFormat);
    }

    public void SetInputContentMinScale(float scale)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetInputContentMinScale, scale);
    }

    public void SetInputContentMaxScale(float scale)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLFXTemporalScalerDescriptorSelector.SetInputContentMaxScale, scale);
    }
    ...
    {
        float result = BitConverter.Int32BitsToSingle((int)ObjectiveCRuntime.MsgSendPtr(s_class, MTLFXTemporalScalerDescriptorSelector.SupportedInputContentMinScale, pDevice.NativePtr));
    ...
    {
        float result = BitConverter.Int32BitsToSingle((int)ObjectiveCRuntime.MsgSendPtr(s_class, MTLFXTemporalScalerDescriptorSelector.SupportedInputContentMaxScale, pDevice.NativePtr));
    ...
    {
        bool result = (byte)ObjectiveCRuntime.MsgSendPtr(s_class, MTLFXTemporalScalerDescriptorSelector.SupportsDevice, pDevice.NativePtr) is not 0;
    ...
    {
        bool result = (byte)ObjectiveCRuntime.MsgSendPtr(s_class, MTLFXTemporalScalerDescriptorSelector.SupportsMetal4FX, pDevice.NativePtr) is not 0;
