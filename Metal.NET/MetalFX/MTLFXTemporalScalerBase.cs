...
public class MTLFXTemporalScalerBase(nint nativePtr, NativeObjectOwnership ownership) : MTLFXFrameInterpolatableScaler(nativePtr, ownership), INativeObject<MTLFXTemporalScalerBase>
{
    ...
    /// <summary>An input color texture you set for the scaler that supports the correct color texture usage options.</summary>
    ...
    /// <summary>The pixel format of the input color texture for this this scaler.</summary>
    public MTLPixelFormat ColorTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXTemporalScalerBaseBindings.ColorTextureFormat);
    }

    /// <summary>The minimal texture usage options that your app’s input color texture needs in order to support this scaler.</summary>
    ...
    /// <summary>An input depth texture you set for the scaler that supports the correct color texture usage options.</summary>
    ...
    /// <summary>The pixel format of the input depth texture for this this scaler.</summary>
    public MTLPixelFormat DepthTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXTemporalScalerBaseBindings.DepthTextureFormat);
    }

    /// <summary>The minimal texture usage options that your app’s input depth texture needs in order to support this scaler.</summary>
    ...
    /// <summary>The exposure texture this scaler uses.</summary>
    ...
    /// <summary>An optional fence that you provide to synchronize your app’s untracked resources.</summary>
    ...
    /// <summary>The height, in pixels, of the region within the color texture the scaler uses as its input.</summary>
    ...
    /// <summary>The largest scale factor the temporal scaler can use to generate output textures.</summary>
    ...
    /// <summary>The smallest scale factor the temporal scaler can use to generate output textures.</summary>
    ...
    /// <summary>The width, in pixels, of the region within the color texture the scaler uses as its input.</summary>
    ...
    /// <summary>The height, in pixels, of the input color texture for this scaler.</summary>
    public nuint InputHeight
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLFXTemporalScalerBaseBindings.InputHeight);
    }

    /// <summary>The width, in pixels, of the input color texture for this scaler.</summary>
    ...
    /// <summary>An input motion texture you set for the scaler that supports the correct color texture usage options.</summary>
    ...
    /// <summary>The pixel format of the input motion texture for this this scaler.</summary>
    public MTLPixelFormat MotionTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXTemporalScalerBaseBindings.MotionTextureFormat);
    }

    /// <summary>The minimal texture usage options that your app’s motion texture needs in order to support this scaler.</summary>
    ...
    /// <summary>The horizontal scale factor the scaler applies to the input motion texture.</summary>
    ...
    /// <summary>The vertical scale factor the scaler applies to the input motion texture.</summary>
    ...
    /// <summary>The height, in pixels, of the output color texture for this scaler.</summary>
    public nuint OutputHeight
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLFXTemporalScalerBaseBindings.OutputHeight);
    }

    /// <summary>The output texture into which this scaler writes its output.</summary>
    ...
    /// <summary>The pixel format of the output color texture for this this scaler.</summary>
    public MTLPixelFormat OutputTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXTemporalScalerBaseBindings.OutputTextureFormat);
    }

    /// <summary>The minimal texture usage options that your output texture needs in order to support this scaler.</summary>
    ...
    /// <summary>The width, in pixels, of the output color texture for this scaler.</summary>
    public nuint OutputWidth
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLFXTemporalScalerBaseBindings.OutputWidth);
    }

    /// <summary>A pre-exposure value this scaler evaluates.</summary>
    ...
    /// <summary>The reactive-mask texture input this scaler uses.</summary>
    ...
    /// <summary>The minimal texture usage options that your app’s reactive texture needs in order to support this scaler.</summary>
    ...
    /// <summary>A Boolean that indicates whether the temporal scaler discards historical data from previous frames.</summary>
    public Bool8 Reset
    {
