...
public class MTLFXFrameInterpolatorDescriptor : IDisposable
{
    ...
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.SetColorTextureFormat, (nint)(uint)colorTextureFormat);
    }

    public void SetOutputTextureFormat(MTLPixelFormat outputTextureFormat)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.SetOutputTextureFormat, (nint)(uint)outputTextureFormat);
    }

    public void SetDepthTextureFormat(MTLPixelFormat depthTextureFormat)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.SetDepthTextureFormat, (nint)(uint)depthTextureFormat);
    }

    public void SetMotionTextureFormat(MTLPixelFormat motionTextureFormat)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.SetMotionTextureFormat, (nint)(uint)motionTextureFormat);
    }

    public void SetUITextureFormat(MTLPixelFormat uiTextureFormat)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.SetUITextureFormat, (nint)(uint)uiTextureFormat);
    }

    public void SetScaler(MTLFXFrameInterpolatableScaler scaler)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.SetScaler, scaler.NativePtr);
    }

    public void SetInputWidth(uint inputWidth)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.SetInputWidth, (nint)inputWidth);
    }

    public void SetInputHeight(uint inputHeight)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.SetInputHeight, (nint)inputHeight);
    }

    public void SetOutputWidth(uint outputWidth)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.SetOutputWidth, (nint)outputWidth);
    }

    public void SetOutputHeight(uint outputHeight)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.SetOutputHeight, (nint)outputHeight);
    }

    public MTLFXFrameInterpolator NewFrameInterpolator(MTLDevice pDevice)
    {
        var result = new MTLFXFrameInterpolator(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.NewFrameInterpolator, pDevice.NativePtr));
    ...
    {
        var result = new MTLFXFrameInterpolator(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTLFXFrameInterpolatorDescriptorSelector.NewFrameInterpolatorPCompiler, pDevice.NativePtr, pCompiler.NativePtr));
    ...
    {
        var result = (byte)ObjectiveCRuntime.intptr_objc_msgSend(s_class, MTLFXFrameInterpolatorDescriptorSelector.SupportsMetal4FX, device.NativePtr) is not 0;
    ...
    {
        var result = (byte)ObjectiveCRuntime.intptr_objc_msgSend(s_class, MTLFXFrameInterpolatorDescriptorSelector.SupportsDevice, device.NativePtr) is not 0;
