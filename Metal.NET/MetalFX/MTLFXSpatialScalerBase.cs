...
public class MTLFXSpatialScalerBase(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLFXSpatialScalerBase>
{
    ...
    /// <summary>The color processing mode you set in this spatial scaler’s descriptor.</summary>
    ...
    /// <summary>Input color texture you set for the scaler that supports the correct color texture usage options.</summary>
    ...
    /// <summary>The minimal texture usage options that your app’s output color texture needs in order to support this scaler.</summary>
