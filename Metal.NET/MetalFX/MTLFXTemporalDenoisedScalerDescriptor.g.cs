...
public class MTLFXTemporalDenoisedScalerDescriptor : IDisposable
{
    ...
    ~MTLFXTemporalDenoisedScalerDescriptor() => Release();
    ...
    {
        var __r = new MTLFXTemporalDenoisedScaler(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerDescriptor_Selectors.newTemporalDenoisedScaler_, device.NativePtr));
        return __r;
    }

    public MTLFXTemporalDenoisedScaler NewTemporalDenoisedScaler(MTLDevice device, MTL4Compiler compiler)
    {
        var __r = new MTLFXTemporalDenoisedScaler(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerDescriptor_Selectors.newTemporalDenoisedScaler_compiler_, device.NativePtr, compiler.NativePtr));
        return __r;
    }

    public static float SupportedInputContentMinScale(MTLDevice device)
    {
        var __r = BitConverter.Int32BitsToSingle((int)ObjectiveCRuntime.intptr_objc_msgSend(s_class, MTLFXTemporalDenoisedScalerDescriptor_Selectors.supportedInputContentMinScale_, device.NativePtr));
        return __r;
    }

    public static float SupportedInputContentMaxScale(MTLDevice device)
    {
        var __r = BitConverter.Int32BitsToSingle((int)ObjectiveCRuntime.intptr_objc_msgSend(s_class, MTLFXTemporalDenoisedScalerDescriptor_Selectors.supportedInputContentMaxScale_, device.NativePtr));
        return __r;
    }

    public static Bool8 SupportsMetal4FX(MTLDevice device)
    {
        var __r = (byte)ObjectiveCRuntime.intptr_objc_msgSend(s_class, MTLFXTemporalDenoisedScalerDescriptor_Selectors.supportsMetal4FX_, device.NativePtr) != 0;
        return __r;
    }

    public static Bool8 SupportsDevice(MTLDevice device)
    {
        var __r = (byte)ObjectiveCRuntime.intptr_objc_msgSend(s_class, MTLFXTemporalDenoisedScalerDescriptor_Selectors.supportsDevice_, device.NativePtr) != 0;
        return __r;
    }
