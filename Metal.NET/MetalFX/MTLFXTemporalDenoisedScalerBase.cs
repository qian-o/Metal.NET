...
public class MTLFXTemporalDenoisedScalerBase(nint nativePtr, NativeObjectOwnership ownership) : MTLFXFrameInterpolatableScaler(nativePtr, ownership), INativeObject<MTLFXTemporalDenoisedScalerBase>
{
    ...
    /// <summary>Assigns the color texture this scaler evaluates.</summary>
    ...
    /// <summary>The pixel format of the input color texture for this denoiser scaler.</summary>
    public MTLPixelFormat ColorTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXTemporalDenoisedScalerBaseBindings.ColorTextureFormat);
    }

    /// <summary>The minimal texture usage options that your app’s input color texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>The denoise strength mask texture this scaler evaluates.</summary>
    ...
    /// <summary>The pixel format of the input denoise strength mask texture for this denoiser scaler.</summary>
    ...
    /// <summary>The minimal texture usage options that your app’s input denoise strength texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>The depth texture this scaler evaluates.</summary>
    ...
    /// <summary>The pixel format of the input depth texture for this denoiser scaler.</summary>
    public MTLPixelFormat DepthTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXTemporalDenoisedScalerBaseBindings.DepthTextureFormat);
    }

    /// <summary>The minimal texture usage options that your app’s input depth texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>The diffuse albedo texture this scaler evaluates.</summary>
    ...
    /// <summary>The pixel format of the input diffuse albedo texture for this denoiser scaler.</summary>
    ...
    /// <summary>The minimal texture usage options that your app’s input diffuse albedo texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>An exposure texture that this denoiser scaler evaluates.</summary>
    ...
    /// <summary>An optional fence that this denoiser scaler waits for and updates.</summary>
    ...
    /// <summary>The maximum input content scale this scaler supports.</summary>
    ...
    /// <summary>The minimum input content scale this scaler supports.</summary>
    ...
    /// <summary>The height, in pixels, of the input color texture for the scaler.</summary>
    public nuint InputHeight
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLFXTemporalDenoisedScalerBaseBindings.InputHeight);
    }

    /// <summary>The width, in pixels, of the input color texture for the scaler.</summary>
    public nuint InputWidth
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLFXTemporalDenoisedScalerBaseBindings.InputWidth);
    }

    /// <summary>A Boolean value that indicates whether the depth texture uses zero to represent the farthest distance.</summary>
    ...
    /// <summary>The horizontal component of the subpixel sampling coordinate you use to generate the color texture input.</summary>
    ...
    /// <summary>The vertical component of the subpixel sampling coordinate you use to generate the color texture input.</summary>
    ...
    /// <summary>The motion texture this scaler evaluates.</summary>
    ...
    /// <summary>The pixel format of the input motion texture for this denoiser scaler.</summary>
    public MTLPixelFormat MotionTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXTemporalDenoisedScalerBaseBindings.MotionTextureFormat);
    }

    /// <summary>The minimal texture usage options that your app’s input motion texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>The horizontal scale factor the denoiser scaler applies to the input motion texture.</summary>
    ...
    /// <summary>The vertical scale factor the denoiser scaler applies to the input motion texture.</summary>
    ...
    /// <summary>The normal texture this scaler evaluates.</summary>
    ...
    /// <summary>The pixel format of the input normal texture for this denoiser scaler.</summary>
    ...
    /// <summary>The minimal texture usage options that your app’s input normal texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>The height, in pixels, of the output color texture for the scaler.</summary>
    public nuint OutputHeight
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLFXTemporalDenoisedScalerBaseBindings.OutputHeight);
    }

    /// <summary>The output texture into which this denoiser scaler writes its output.</summary>
    ...
    /// <summary>The pixel format of the output color texture for this denoiser scaler.</summary>
    public MTLPixelFormat OutputTextureFormat
    {
        get => (MTLPixelFormat)ObjectiveC.MsgSendULong(NativePtr, MTLFXTemporalDenoisedScalerBaseBindings.OutputTextureFormat);
    }

    /// <summary>The minimal texture usage options that your app’s output texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>The width, in pixels, of the output color texture for the scaler.</summary>
    public nuint OutputWidth
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLFXTemporalDenoisedScalerBaseBindings.OutputWidth);
    }

    /// <summary>A pre-exposure value for this scaler to evaluate.</summary>
    ...
    /// <summary>A reactive-mask texture input for this scaler to evaluate.</summary>
    ...
    /// <summary>The pixel format of the input reactive mask texture for this denoiser scaler.</summary>
    ...
    /// <summary>The minimal texture usage options that your app’s input reactive texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>The roughness texture this scaler evaluates.</summary>
    ...
    /// <summary>The minimal texture usage options that your app’s input roughness texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>A Boolean property indicating whether to reset history.</summary>
    ...
    /// <summary>The specular albedo texture this scaler evaluates.</summary>
    ...
    /// <summary>The pixel format of the input specular albedo for this denoiser scaler.</summary>
    ...
    /// <summary>The minimal texture usage options that your app’s input specular albedo texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>The specular hit texture this scaler evaluates.</summary>
    ...
    /// <summary>The pixel format of the input specular hit distance texture for this denoiser scaler.</summary>
    ...
    /// <summary>The minimal texture usage options that your app’s input specular hit texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>The transparency overlay texture that this scaler evaluates.</summary>
    ...
    /// <summary>The pixel format of the input transparency overlay texture for this denoiser scaler.</summary>
    ...
    /// <summary>The minimal texture usage options that your app’s input transparency overlay texture needs in order to support this denoiser scaler.</summary>
    ...
    /// <summary>The view-to-clip coordinates transformation matrix this scaler uses as part of its operation.</summary>
    ...
    /// <summary>The world-to-view transformation matrix this scaler uses as part of its operation.</summary>
