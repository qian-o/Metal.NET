...
public class MTLFXTemporalDenoisedScalerBase : IDisposable
{
    ...
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetColorTexture, colorTexture.NativePtr);
    }

    public void SetDepthTexture(MTLTexture depthTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetDepthTexture, depthTexture.NativePtr);
    }

    public void SetMotionTexture(MTLTexture motionTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetMotionTexture, motionTexture.NativePtr);
    }

    public void SetDiffuseAlbedoTexture(MTLTexture diffuseAlbedoTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetDiffuseAlbedoTexture, diffuseAlbedoTexture.NativePtr);
    }

    public void SetSpecularAlbedoTexture(MTLTexture specularAlbedoTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetSpecularAlbedoTexture, specularAlbedoTexture.NativePtr);
    }

    public void SetNormalTexture(MTLTexture normalTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetNormalTexture, normalTexture.NativePtr);
    }

    public void SetRoughnessTexture(MTLTexture roughnessTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetRoughnessTexture, roughnessTexture.NativePtr);
    }

    public void SetSpecularHitDistanceTexture(MTLTexture specularHitDistanceTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetSpecularHitDistanceTexture, specularHitDistanceTexture.NativePtr);
    }

    public void SetDenoiseStrengthMaskTexture(MTLTexture denoiseStrengthMaskTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetDenoiseStrengthMaskTexture, denoiseStrengthMaskTexture.NativePtr);
    }

    public void SetTransparencyOverlayTexture(MTLTexture transparencyOverlayTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetTransparencyOverlayTexture, transparencyOverlayTexture.NativePtr);
    }

    public void SetOutputTexture(MTLTexture outputTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetOutputTexture, outputTexture.NativePtr);
    }

    public void SetExposureTexture(MTLTexture exposureTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetExposureTexture, exposureTexture.NativePtr);
    }

    public void SetPreExposure(float preExposure)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetPreExposure, preExposure);
    }

    public void SetReactiveMaskTexture(MTLTexture reactiveMaskTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetReactiveMaskTexture, reactiveMaskTexture.NativePtr);
    }

    public void SetJitterOffsetX(float jitterOffsetX)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetJitterOffsetX, jitterOffsetX);
    }

    public void SetJitterOffsetY(float jitterOffsetY)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetJitterOffsetY, jitterOffsetY);
    }

    public void SetMotionVectorScaleX(float motionVectorScaleX)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetMotionVectorScaleX, motionVectorScaleX);
    }

    public void SetMotionVectorScaleY(float motionVectorScaleY)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetMotionVectorScaleY, motionVectorScaleY);
    }

    public void SetShouldResetHistory(Bool8 shouldResetHistory)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetShouldResetHistory, (nint)shouldResetHistory.Value);
    }

    public void SetDepthReversed(Bool8 depthReversed)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetDepthReversed, (nint)depthReversed.Value);
    }

    public void SetWorldToViewMatrix(int worldToViewMatrix)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetWorldToViewMatrix, worldToViewMatrix);
    }

    public void SetViewToClipMatrix(int viewToClipMatrix)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetViewToClipMatrix, viewToClipMatrix);
    }

    public void SetFence(MTLFence fence)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXTemporalDenoisedScalerBaseSelector.SetFence, fence.NativePtr);
    }
