...
public class MTL4FXTemporalDenoisedScaler(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTL4FXTemporalDenoisedScaler>
{
