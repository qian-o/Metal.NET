...
public class MTLFXFrameInterpolatorBase : IDisposable
{
    ...
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetColorTexture, colorTexture.NativePtr);
    }

    public void SetPrevColorTexture(MTLTexture prevColorTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetPrevColorTexture, prevColorTexture.NativePtr);
    }

    public void SetDepthTexture(MTLTexture depthTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetDepthTexture, depthTexture.NativePtr);
    }

    public void SetMotionTexture(MTLTexture motionTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetMotionTexture, motionTexture.NativePtr);
    }

    public void SetMotionVectorScaleX(float scaleX)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetMotionVectorScaleX, scaleX);
    }

    public void SetMotionVectorScaleY(float scaleY)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetMotionVectorScaleY, scaleY);
    }

    public void SetDeltaTime(float deltaTime)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetDeltaTime, deltaTime);
    }

    public void SetNearPlane(float nearPlane)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetNearPlane, nearPlane);
    }

    public void SetFarPlane(float farPlane)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetFarPlane, farPlane);
    }

    public void SetFieldOfView(float fieldOfView)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetFieldOfView, fieldOfView);
    }

    public void SetAspectRatio(float aspectRatio)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetAspectRatio, aspectRatio);
    }

    public void SetUITexture(MTLTexture uiTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetUITexture, uiTexture.NativePtr);
    }

    public void SetJitterOffsetX(float jitterOffsetX)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetJitterOffsetX, jitterOffsetX);
    }

    public void SetJitterOffsetY(float jitterOffsetY)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetJitterOffsetY, jitterOffsetY);
    }

    public void SetIsUITextureComposited(Bool8 uiTextureComposited)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetIsUITextureComposited, (nint)uiTextureComposited.Value);
    }

    public void SetShouldResetHistory(Bool8 shouldResetHistory)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetShouldResetHistory, (nint)shouldResetHistory.Value);
    }

    public void SetOutputTexture(MTLTexture outputTexture)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetOutputTexture, outputTexture.NativePtr);
    }

    public void SetFence(MTLFence fence)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetFence, fence.NativePtr);
    }

    public void SetDepthReversed(Bool8 depthReversed)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLFXFrameInterpolatorBaseSelector.SetDepthReversed, (nint)depthReversed.Value);
    }
