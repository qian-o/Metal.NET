...
public class MTL4FXSpatialScaler(nint nativePtr, bool ownsReference, bool allowGCRelease = false) : MTLFXSpatialScalerBase(nativePtr, ownsReference, allowGCRelease), INativeObject<MTL4FXSpatialScaler>
{
