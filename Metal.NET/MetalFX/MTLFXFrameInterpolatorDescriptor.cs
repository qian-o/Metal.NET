...
{
    public static MTLFXFrameInterpolatorDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTLFXFrameInterpolatorDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
