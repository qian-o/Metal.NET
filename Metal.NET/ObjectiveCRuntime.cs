...
public static unsafe partial class ObjectiveCRuntime
{
    ...
    [LibraryImport(ObjCLibrary, EntryPoint = "objc_msgSend")]
    public static partial nint intptr_objc_msgSend(nint receiver, Selector selector, out NSError error);

    [LibraryImport(ObjCLibrary, EntryPoint = "objc_msgSend")]
    public static partial nint intptr_objc_msgSend(nint receiver, Selector selector, nint a, out NSError error);

    [LibraryImport(ObjCLibrary, EntryPoint = "objc_msgSend")]
    public static partial nint intptr_objc_msgSend(nint receiver, Selector selector, nint a, nint b, out NSError error);

    [LibraryImport(ObjCLibrary, EntryPoint = "objc_msgSend")]
    public static partial nint intptr_objc_msgSend(nint receiver, Selector selector, nint a, nint b, nint c, out NSError error);

    [LibraryImport(ObjCLibrary, EntryPoint = "objc_msgSend")]
    public static partial nint intptr_objc_msgSend(nint receiver, Selector selector, nint a, nint b, nint c, nint d, out NSError error);
