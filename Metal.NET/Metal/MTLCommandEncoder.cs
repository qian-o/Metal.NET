...
public class MTLCommandEncoder(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLCommandEncoder>
{
    ...
    /// <summary>The Metal device from which the command encoder was created.</summary>
    public MTLDevice Device
    {
        get => GetProperty(ref field, MTLCommandEncoderBindings.Device);
    }

    /// <summary>A string that labels the command encoder.</summary>
    ...
    /// <summary>Declares that all command generation from the encoder is completed.</summary>
    ...
    /// <summary>Inserts a debug string into the captured frame data.</summary>
    public void InsertDebugSignpost(NSString @string)
    {
        ObjectiveC.MsgSend(NativePtr, MTLCommandEncoderBindings.InsertDebugSignpost, @string.NativePtr);
    }

    /// <summary>Pushes a specific string onto a stack of debug group strings for the command encoder.</summary>
    public void PushDebugGroup(NSString @string)
    {
        ObjectiveC.MsgSend(NativePtr, MTLCommandEncoderBindings.PushDebugGroup, @string.NativePtr);
    }

    /// <summary>Pops the latest string off of a stack of debug group strings for the command encoder.</summary>
    ...
    /// <summary>Encodes a consumer barrier on work you commit to the same command queue.</summary>
