...
{
    public static MTL4PipelineDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTL4PipelineDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
