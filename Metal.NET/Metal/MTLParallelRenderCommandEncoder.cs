...
public class MTLParallelRenderCommandEncoder(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLParallelRenderCommandEncoder>
{
