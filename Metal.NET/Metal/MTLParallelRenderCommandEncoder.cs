...
/// <summary>An instance that splits up a single render pass so that it can be simultaneously encoded from multiple threads.</summary>
public class MTLParallelRenderCommandEncoder(nint nativePtr, NativeObjectOwnership ownership) : MTLCommandEncoder(nativePtr, ownership), INativeObject<MTLParallelRenderCommandEncoder>
{
    ...
    /// <summary>Create an object that encodes commands that perform graphics rendering operations and may be assigned to a different thread.</summary>
    ...
    /// <summary>Specifies a known store action to replace the initial  value specified for a given color attachment.</summary>
    ...
    /// <summary>Specifies known store action options for a given color attachment.</summary>
    ...
    /// <summary>Specifies a known store action to replace the initial  value specified for a given depth attachment.</summary>
    public void SetDepthStoreAction(MTLStoreAction storeAction)
    {
        ObjectiveC.MsgSend(NativePtr, MTLParallelRenderCommandEncoderBindings.SetDepthStoreAction, (nuint)storeAction);
    }

    /// <summary>Specifies known store action options for a given depth attachment.</summary>
    ...
    /// <summary>Specifies a known store action to replace the initial  value specified for a given stencil attachment.</summary>
    public void SetStencilStoreAction(MTLStoreAction storeAction)
    {
        ObjectiveC.MsgSend(NativePtr, MTLParallelRenderCommandEncoderBindings.SetStencilStoreAction, (nuint)storeAction);
    }

    /// <summary>Specifies known store action options for a given stencil attachment.</summary>
