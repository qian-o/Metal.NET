...
public class MTLBuffer(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLBuffer>
{
    ...
    public MTLTexture NewTextureWithDescriptor(MTLTextureDescriptor descriptor, nuint offset, nuint bytesPerRow)
    {
    ...
    public MTLTensor NewTensorWithDescriptor(MTLTensorDescriptor descriptor, nuint offset, out NSError error)
    {
