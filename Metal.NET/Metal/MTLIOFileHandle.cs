...
/// <summary>Represents a raw or compressed file, such as a resource asset file in your app’s bundle.</summary>
public class MTLIOFileHandle(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLIOFileHandle>
{
    ...
    /// <summary>An optional name for the file that the handle represents.</summary>
