...
public class MTLCaptureDescriptor(nint nativePtr, bool ownsReference, bool allowGCRelease = false) : NativeObject(nativePtr, ownsReference, allowGCRelease), INativeObject<MTLCaptureDescriptor>
{
    public static MTLCaptureDescriptor Null { get; } = new(0, false);
