...
public class MTL4RenderPassDescriptor(nint nativePtr, bool ownsReference, bool allowGCRelease) : NativeObject(nativePtr, ownsReference, allowGCRelease), INativeObject<MTL4RenderPassDescriptor>
{
    public static MTL4RenderPassDescriptor Null { get; } = new(0, false, false);

    public static MTL4RenderPassDescriptor Create(nint nativePtr, bool ownsReference, bool allowGCRelease) => new(nativePtr, ownsReference, allowGCRelease);
