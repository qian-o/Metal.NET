...
{
    public static MTL4RenderPassDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTL4RenderPassDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
