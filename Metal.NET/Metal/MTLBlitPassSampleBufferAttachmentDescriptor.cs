...
/// <summary>A configuration that instructs the GPU where to store counter data from the beginning and end of a blit pass.</summary>
public class MTLBlitPassSampleBufferAttachmentDescriptor(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLBlitPassSampleBufferAttachmentDescriptor>
{
    ...
    /// <summary>A specialized memory buffer that the GPU uses to store its counter data during the blit pass.</summary>
    ...
    /// <summary>An index within a counter sample buffer that tells the GPU where to store counter data from the start of a blit pass.</summary>
    ...
    /// <summary>An index within a counter sample buffer that tells the GPU where to store counter data from the end of a blit pass.</summary>
