...
/// <summary>Encodes configuration and draw commands for a single render pass into a command buffer.</summary>
public class MTLRenderCommandEncoder(nint nativePtr, NativeObjectOwnership ownership) : MTLCommandEncoder(nativePtr, ownership), INativeObject<MTLRenderCommandEncoder>
{
    ...
    /// <summary>The width of the tiles, in pixels, for the render command encoder.</summary>
    public nuint TileWidth
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLRenderCommandEncoderBindings.TileWidth);
    }

    /// <summary>The height of the tiles, in pixels, for the render command encoder.</summary>
    ...
    /// <summary>Encodes a draw command that renders an instance of a geometric primitive.</summary>
    ...
    /// <summary>Encodes a draw command that renders an instance of a geometric primitive with indexed vertices.</summary>
    ...
    /// <summary>Encodes a draw command that invokes a mesh shader and, optionally, an object shader with a grid of threads.</summary>
    ...
    /// <summary>Encodes a draw command that invokes a mesh shader and, optionally, an object shader with a grid of threadgroups.</summary>
    ...
    /// <summary>Encodes a draw command that renders multiple instances of tessellated patches.</summary>
    ...
    /// <summary>Encodes a draw command that renders multiple instances of tessellated patches with a control point index buffer.</summary>
    ...
    /// <summary>Encodes a command that invokes GPU functions from the encoder’s current tile render pipeline state.</summary>
    ...
    /// <summary>Encodes a command that instructs the GPU to pause before starting one or more stages of the render pass until a pass updates a fence.</summary>
    ...
    /// <summary>Encodes a command that instructs the GPU to update a fence after one or more stages, which can unblock other passes waiting for the fence.</summary>
    ...
    /// <summary>Creates a memory barrier that enforces the order of write and read operations for specific resources.</summary>
    ...
    /// <summary>Encodes a command that runs a range of commands from an indirect command buffer (ICB).</summary>
    ...
    /// <summary>Encodes a command that samples hardware counters during the render pass and stores the data into a counter sample buffer.</summary>
    ...
    /// <summary>Configures the encoder with a render or tile pipeline state that applies to your subsequent draw commands.</summary>
    ...
    /// <summary>Configures the store action for a color attachment.</summary>
    ...
    /// <summary>Configures the store action options for a color attachment.</summary>
    ...
    /// <summary>Configures the store action for the depth attachment.</summary>
    public void SetDepthStoreAction(MTLStoreAction storeAction)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderCommandEncoderBindings.SetDepthStoreAction, (nuint)storeAction);
    }

    /// <summary>Configures the store action options for the depth attachment.</summary>
    ...
    /// <summary>Configures the store action for the stencil attachment.</summary>
    public void SetStencilStoreAction(MTLStoreAction storeAction)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderCommandEncoderBindings.SetStencilStoreAction, (nuint)storeAction);
    }

    /// <summary>Configures the store action options for the stencil attachment.</summary>
    ...
    /// <summary>Configures each pixel component value, including alpha, for the render pipeline’s constant blend color.</summary>
    ...
    /// <summary>Sets the mapping from logical shader color output to physical render pass color attachments.</summary>
    ...
    /// <summary>Configures how subsequent draw commands rasterize triangle and triangle strip primitives.</summary>
    public void SetTriangleFillMode(MTLTriangleFillMode fillMode)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderCommandEncoderBindings.SetTriangleFillMode, (nuint)fillMode);
    }

    /// <summary>Configures which face of a primitive, such as a triangle, is the front.</summary>
    ...
    /// <summary>Configures how the render pipeline determines which primitives to remove.</summary>
    ...
    /// <summary>Configures the combined depth and stencil state.</summary>
    ...
    /// <summary>Configures the adjustments a render pass applies to depth values from fragment functions by a scaling factor and bias.</summary>
    ...
    /// <summary>Configures how the render pipeline handles fragments outside the near and far planes of the view frustum.</summary>
    public void SetDepthClipMode(MTLDepthClipMode depthClipMode)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderCommandEncoderBindings.SetDepthClipMode, (nuint)depthClipMode);
    }

    /// <summary>Configures the range for depth bounds testing.</summary>
    ...
    /// <summary>Configures the same comparison value for front- and back-facing primitives.</summary>
    ...
    /// <summary>Configures different comparison values for front- and back-facing primitives.</summary>
    ...
    /// <summary>Configures the render pipeline with a viewport that applies a transformation and a clipping rectangle.</summary>
    ...
    /// <summary>Configures the render pipeline with multiple viewports that apply transformations and clipping rectangles.</summary>
    ...
    /// <summary>Configures a rectangle for the fragment scissor test.</summary>
    ...
    /// <summary>Configures multiple rectangles for the fragment scissor test.</summary>
    ...
    /// <summary>Configures which visibility test the GPU runs and the destination for any results it generates.</summary>
    ...
    /// <summary>Configures the number of output vertices the render pipeline produces for each input vertex, optionally with render target and viewport offsets.</summary>
    ...
    /// <summary>Configures the scale factor for per-patch tessellation factors.</summary>
    ...
    /// <summary>Configures the per-patch tessellation factors for any subsequent patch-drawing commands.</summary>
    ...
    /// <summary>Configures the size of a threadgroup memory buffer for an entry in the object argument table.</summary>
    ...
    /// <summary>Configures the size of a threadgroup memory buffer for an entry in the fragment or tile shader argument table.</summary>
    ...
    /// <summary>Assigns a buffer to an entry in the object shader argument table.</summary>
    ...
    /// <summary>Creates a buffer from bytes and assigns it to an entry in the object shader argument table.</summary>
    ...
    /// <summary>Updates an entry in the object shader argument table with a new location within the entry’s current buffer.</summary>
    ...
    /// <summary>Assigns a texture to an entry in the object shader argument table.</summary>
    ...
    /// <summary>Assigns a sampler state to an entry in the object shader argument table.</summary>
    ...
    /// <summary>Assigns a buffer to an entry in the mesh shader argument table.</summary>
    ...
    /// <summary>Creates a buffer from bytes and assigns it to an entry in the mesh shader argument table.</summary>
    ...
    /// <summary>Updates an entry in the mesh shader argument table with a new location within the entry’s current buffer.</summary>
    ...
    /// <summary>Assigns a texture to an entry in the mesh shader argument table.</summary>
    ...
    /// <summary>Assigns a sampler state to an entry in the mesh shader argument table.</summary>
    ...
    /// <summary>Assigns a buffer to an entry in the vertex shader argument table.</summary>
    ...
    /// <summary>Creates a buffer from bytes and assigns it to an entry in the vertex shader argument table.</summary>
    ...
    /// <summary>Updates an entry in the vertex shader argument table with a new location within the entry’s current buffer.</summary>
    ...
    /// <summary>Assigns a buffer to an entry in the fragment shader argument table.</summary>
    ...
    /// <summary>Creates a buffer from bytes and assigns it to an entry in the fragment shader argument table.</summary>
    ...
    /// <summary>Updates an entry in the fragment shader argument table with a new location within the entry’s current buffer.</summary>
    ...
    /// <summary>Assigns a buffer to an entry in the tile shader argument table.</summary>
    ...
    /// <summary>Creates a buffer from bytes and assigns it to an entry in the tile shader argument table.</summary>
    ...
    /// <summary>Updates an entry in the tile shader argument table with a new location within the entry’s current buffer.</summary>
    ...
    /// <summary>Assigns a texture to an entry in the vertex shader argument table.</summary>
    ...
    /// <summary>Assigns a texture to an entry in the fragment shader argument table.</summary>
    ...
    /// <summary>Assigns a texture to an entry in the tile shader argument table.</summary>
    ...
    /// <summary>Assigns a sampler state to an entry in the vertex shader argument table.</summary>
    ...
    /// <summary>Assigns a sampler state to an entry in the fragment shader argument table.</summary>
    ...
    /// <summary>Assigns a sampler state to an entry in the tile shader argument table.</summary>
    ...
    /// <summary>Assigns an acceleration structure to an entry in the vertex shader argument table.</summary>
    ...
    /// <summary>Assigns an acceleration structure to an entry in the fragment shader argument table.</summary>
    ...
    /// <summary>Assigns an acceleration structure to an entry in the tile shader argument table.</summary>
    ...
    /// <summary>Assigns a visible function table to an entry in the vertex shader argument table.</summary>
    ...
    /// <summary>Assigns a visible function table to an entry in the fragment shader argument table.</summary>
    ...
    /// <summary>Assigns a visible function table to an entry in the tile shader argument table.</summary>
    ...
    /// <summary>Assigns an intersection function table to an entry in the vertex shader argument table.</summary>
    ...
    /// <summary>Assigns an intersection function table to an entry in the fragment shader argument table.</summary>
    ...
    /// <summary>Assigns an intersection function table to an entry in the tile shader argument table.</summary>
    ...
    /// <summary>Ensures the shaders in the render pass’s subsequent draw commands have access to a resource.</summary>
    ...
    /// <summary>Ensures the shaders in the render pass’s subsequent draw commands have access to multiple resources.</summary>
    ...
    /// <summary>Ensures the shaders in the render pass’s subsequent draw commands have access to the resources you allocate from a heap.</summary>
    ...
    /// <summary>Ensures the shaders in the render pass’s subsequent draw commands have access to the resources you allocate from multiple heaps.</summary>
    ...
    /// <summary>Adds a barrier, which forces any texture read operations to wait until write operations to the same texture finish.</summary>
