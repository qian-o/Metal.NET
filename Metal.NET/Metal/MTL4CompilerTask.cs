...
/// <summary>A reference to an asynchronous compilation task that you initiate from a compiler instance.</summary>
public class MTL4CompilerTask(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTL4CompilerTask>
{
    ...
    /// <summary>Returns the compiler instance that this asynchronous compiler task belongs to.</summary>
    public MTL4Compiler Compiler
    {
        get => GetProperty(ref field, MTL4CompilerTaskBindings.Compiler);
    }

    /// <summary>Returns the compiler task status.</summary>
