...
/// <summary>A description of an array.</summary>
public class MTLArrayType(nint nativePtr, NativeObjectOwnership ownership) : MTLType(nativePtr, ownership), INativeObject<MTLArrayType>
{
    ...
    /// <summary>Provides a description of the underlying type when an array holds other arrays as its elements.</summary>
    ...
    /// <summary>Provides a description of the underlying struct type when an array holds structs as its elements.</summary>
    ...
    /// <summary>Provides a description of the underlying pointer type when an array holds pointers as its elements.</summary>
    ...
    /// <summary>Provides a description of the underlying texture type when an array holds textures as its elements.</summary>
    ...
    /// <summary>Provides a description of the underlying tensor type when this array holds tensors as its elements.</summary>
