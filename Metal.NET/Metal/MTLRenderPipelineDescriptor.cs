...
public class MTLRenderPipelineDescriptor(nint nativePtr, bool ownsReference, bool allowGCRelease = false) : NativeObject(nativePtr, ownsReference, allowGCRelease), INativeObject<MTLRenderPipelineDescriptor>
{
    public static MTLRenderPipelineDescriptor Null { get; } = new(0, false);
