...
public class MTLTextureViewPool(nint nativePtr) : NativeObject(nativePtr)
{
    ...
    {
        return ObjectiveCRuntime.MsgSendMTLResourceID(NativePtr, MTLTextureViewPoolBindings.SetTextureView, texture.NativePtr, descriptor.NativePtr, index);
    }
