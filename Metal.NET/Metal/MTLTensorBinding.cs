...
{
    public static new MTLTensorBinding Create(nint nativePtr) => new(nativePtr, true);

    public static new MTLTensorBinding CreateBorrowed(nint nativePtr) => new(nativePtr, false);
