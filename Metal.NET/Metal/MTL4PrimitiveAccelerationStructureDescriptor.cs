...
/// <summary>Descriptor for a primitive acceleration structure that directly references geometric shapes, such as triangles and bounding boxes.</summary>
public class MTL4PrimitiveAccelerationStructureDescriptor(nint nativePtr, NativeObjectOwnership ownership) : MTL4AccelerationStructureDescriptor(nativePtr, ownership), INativeObject<MTL4PrimitiveAccelerationStructureDescriptor>
{
    ...
    /// <summary>Associates the array of geometry descriptors that comprise this primitive acceleration structure.</summary>
    ...
    /// <summary>Configures the motion border mode.</summary>
    ...
    /// <summary>Configures the motion end time for this geometry.</summary>
    ...
    /// <summary>Sets the motion keyframe count.</summary>
    ...
    /// <summary>Configures the behavior when the ray-tracing system samples the acceleration structure before the motion start time.</summary>
    ...
    /// <summary>Configures the motion start time for this geometry.</summary>
