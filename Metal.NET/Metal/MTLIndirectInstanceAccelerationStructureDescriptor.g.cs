...
public class MTLIndirectInstanceAccelerationStructureDescriptor : IDisposable
{
    ...
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetInstanceCountBuffer, instanceCountBuffer.NativePtr);
    }

    public void SetInstanceCountBufferOffset(uint instanceCountBufferOffset)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetInstanceCountBufferOffset, (nint)instanceCountBufferOffset);
    }

    public void SetInstanceDescriptorBuffer(MTLBuffer instanceDescriptorBuffer)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetInstanceDescriptorBuffer, instanceDescriptorBuffer.NativePtr);
    }

    public void SetInstanceDescriptorBufferOffset(uint instanceDescriptorBufferOffset)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetInstanceDescriptorBufferOffset, (nint)instanceDescriptorBufferOffset);
    }

    public void SetInstanceDescriptorStride(uint instanceDescriptorStride)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetInstanceDescriptorStride, (nint)instanceDescriptorStride);
    }

    public void SetInstanceDescriptorType(MTLAccelerationStructureInstanceDescriptorType instanceDescriptorType)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetInstanceDescriptorType, (nint)(uint)instanceDescriptorType);
    }

    public void SetInstanceTransformationMatrixLayout(MTLMatrixLayout instanceTransformationMatrixLayout)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetInstanceTransformationMatrixLayout, (nint)(uint)instanceTransformationMatrixLayout);
    }

    public void SetMaxInstanceCount(uint maxInstanceCount)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetMaxInstanceCount, (nint)maxInstanceCount);
    }

    public void SetMaxMotionTransformCount(uint maxMotionTransformCount)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetMaxMotionTransformCount, (nint)maxMotionTransformCount);
    }

    public void SetMotionTransformBuffer(MTLBuffer motionTransformBuffer)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetMotionTransformBuffer, motionTransformBuffer.NativePtr);
    }

    public void SetMotionTransformBufferOffset(uint motionTransformBufferOffset)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetMotionTransformBufferOffset, (nint)motionTransformBufferOffset);
    }

    public void SetMotionTransformCountBuffer(MTLBuffer motionTransformCountBuffer)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetMotionTransformCountBuffer, motionTransformCountBuffer.NativePtr);
    }

    public void SetMotionTransformCountBufferOffset(uint motionTransformCountBufferOffset)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetMotionTransformCountBufferOffset, (nint)motionTransformCountBufferOffset);
    }

    public void SetMotionTransformStride(uint motionTransformStride)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetMotionTransformStride, (nint)motionTransformStride);
    }

    public void SetMotionTransformType(MTLTransformType motionTransformType)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLIndirectInstanceAccelerationStructureDescriptorSelector.SetMotionTransformType, (nint)(uint)motionTransformType);
    }
