...
public class MTLTensorDescriptor(nint nativePtr, bool ownsReference, bool allowGCRelease) : NativeObject(nativePtr, ownsReference, allowGCRelease), INativeObject<MTLTensorDescriptor>
{
    public static MTLTensorDescriptor Null { get; } = new(0, false, false);

    public static MTLTensorDescriptor Create(nint nativePtr, bool ownsReference, bool allowGCRelease) => new(nativePtr, ownsReference, allowGCRelease);
