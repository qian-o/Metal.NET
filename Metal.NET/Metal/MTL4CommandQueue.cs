...
public class MTL4CommandQueue : IDisposable
{
    ...
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTL4CommandQueueSelector.SignalEventValue, @event.NativePtr, (nint)value);
    }

    public void Wait(MTLEvent @event, uint value)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTL4CommandQueueSelector.WaitValue, @event.NativePtr, (nint)value);
    }
