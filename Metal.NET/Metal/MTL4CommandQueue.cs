...
{
    public static MTL4CommandQueue Create(nint nativePtr) => new(nativePtr, true);

    public static MTL4CommandQueue CreateBorrowed(nint nativePtr) => new(nativePtr, false);
