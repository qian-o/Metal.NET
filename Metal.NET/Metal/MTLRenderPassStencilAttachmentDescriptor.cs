...
/// <summary>A stencil render target that serves as the output destination for stencil pixels generated by a render pass.</summary>
public class MTLRenderPassStencilAttachmentDescriptor(nint nativePtr, NativeObjectOwnership ownership) : MTLRenderPassAttachmentDescriptor(nativePtr, ownership), INativeObject<MTLRenderPassStencilAttachmentDescriptor>
{
    ...
    /// <summary>The filter used for stencil multisample resolve.</summary>
    ...
    /// <summary>The value to use when clearing the stencil attachment.</summary>
