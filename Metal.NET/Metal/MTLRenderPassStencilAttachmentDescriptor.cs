...
public class MTLRenderPassStencilAttachmentDescriptor(nint nativePtr, bool ownsReference = true) : MTLRenderPassAttachmentDescriptor(nativePtr, ownsReference), INativeObject<MTLRenderPassStencilAttachmentDescriptor>
{
    public static new MTLRenderPassStencilAttachmentDescriptor Create(nint nativePtr) => new(nativePtr);

    public static new MTLRenderPassStencilAttachmentDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, ownsReference: false);
