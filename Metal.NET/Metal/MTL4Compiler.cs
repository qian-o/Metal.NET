...
/// <summary>A abstraction for a pipeline state and shader function compiler.</summary>
public class MTL4Compiler(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTL4Compiler>
{
    ...
    /// <summary>Returns the device that this compiler belongs to.</summary>
    public MTLDevice Device
    {
        get => GetProperty(ref field, MTL4CompilerBindings.Device);
    }

    /// <summary>Returns the optional label you specify at creation time.</summary>
    public NSString Label
    {
        get => GetProperty(ref field, MTL4CompilerBindings.Label);
    }

    /// <summary>Returns the pipeline data set serializer into which this compiler stores data for all pipelines it creates.</summary>
    ...
    /// <summary>Creates a new binary visible or intersection function synchronously.</summary>
    ...
    /// <summary>Creates a new compute pipeline state asynchronously.</summary>
    ...
    /// <summary>Creates a new dynamic library from a library containing Metal IR code synchronously.</summary>
    ...
    /// <summary>Creates a new Metal library synchronously.</summary>
    ...
    /// <summary>Creates a new machine learning pipeline state asynchronously.</summary>
    ...
    /// <summary>Creates a new render pipeline state asynchronously.</summary>
    ...
    /// <summary>Creates a new render pipeline state from another, previously unspecialized, pipeline state.</summary>
