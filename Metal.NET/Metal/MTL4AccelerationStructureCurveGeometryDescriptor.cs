...
/// <summary>Describes curve geometry suitable for ray tracing.</summary>
public class MTL4AccelerationStructureCurveGeometryDescriptor(nint nativePtr, NativeObjectOwnership ownership) : MTL4AccelerationStructureGeometryDescriptor(nativePtr, ownership), INativeObject<MTL4AccelerationStructureCurveGeometryDescriptor>
{
    ...
    /// <summary>References a buffer containing curve control points.</summary>
    ...
    /// <summary>Declares the number of control points in the control point buffer.</summary>
    ...
    /// <summary>Declares the format of the control points the control point buffer references.</summary>
    ...
    /// <summary>Sets the stride, in bytes, between control points in the control point buffer the control point buffer references.</summary>
    ...
    /// <summary>Controls the curve basis function, determining how Metal interpolates the control points.</summary>
    ...
    /// <summary>Sets the type of curve end caps.</summary>
    ...
    /// <summary>Assigns an optional index buffer containing references to control points in the control point buffer.</summary>
    ...
    /// <summary>Assigns a reference to a buffer containing the curve radius for each control point.</summary>
    ...
    /// <summary>Declares the format of the radii in the radius buffer.</summary>
    ...
    /// <summary>Configures the stride, in bytes, between radii in the radius buffer.</summary>
    ...
    /// <summary>Declares the number of control points per curve segment.</summary>
