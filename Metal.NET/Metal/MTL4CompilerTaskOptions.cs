...
public class MTL4CompilerTaskOptions(nint nativePtr, bool ownsReference, bool allowGCRelease = false) : NativeObject(nativePtr, ownsReference, allowGCRelease), INativeObject<MTL4CompilerTaskOptions>
{
    public static MTL4CompilerTaskOptions Null { get; } = new(0, false);
