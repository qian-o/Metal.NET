...
public class MTL4CommandEncoder(nint nativePtr, bool ownsReference, bool allowGCRelease) : NativeObject(nativePtr, ownsReference, allowGCRelease), INativeObject<MTL4CommandEncoder>
{
    public static MTL4CommandEncoder Null { get; } = new(0, false, false);

    public static MTL4CommandEncoder Create(nint nativePtr, bool ownsReference, bool allowGCRelease) => new(nativePtr, ownsReference, allowGCRelease);
