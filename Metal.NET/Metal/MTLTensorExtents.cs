...
public class MTLTensorExtents(nint nativePtr, NativeObjectOwnership ownership) : ObjectiveCObject(nativePtr, ownership), INativeObject<MTLTensorExtents>
{
    #region INativeObject
    public static MTLTensorExtents Null { get; } = new(0, NativeObjectOwnership.Borrowed);

    public static MTLTensorExtents New(nint nativePtr, NativeObjectOwnership ownership)
    {
