...
public class MTLAccelerationStructureBoundingBoxGeometryDescriptor(nint nativePtr, bool owned) : MTLAccelerationStructureGeometryDescriptor(nativePtr, owned)
{
