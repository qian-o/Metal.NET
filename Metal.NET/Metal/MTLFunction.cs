...
/// <summary>A interface that represents a public shader function in a Metal library.</summary>
public class MTLFunction(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLFunction>
{
    ...
    /// <summary>A string that identifies the shader function.</summary>
    ...
    /// <summary>The options that Metal used to compile this function.</summary>
    ...
    /// <summary>The tessellation patch type of a post-tessellation vertex function.</summary>
    public MTLPatchType PatchType
    {
        get => (MTLPatchType)ObjectiveC.MsgSendULong(NativePtr, MTLFunctionBindings.PatchType);
    }

    /// <summary>The number of patch control points in the post-tessellation vertex function.</summary>
    ...
    /// <summary>An array that describes the vertex input attributes to a vertex function.</summary>
    public MTLVertexAttribute[] VertexAttributes
    {
        get => GetArrayProperty<MTLVertexAttribute>(MTLFunctionBindings.VertexAttributes);
    }

    /// <summary>An array that describes the input attributes to the function.</summary>
    ...
    /// <summary>A dictionary of function constants for a specialized function.</summary>
    ...
    /// <summary>Creates an argument encoder for an argument buffer that’s one of this function’s arguments.</summary>
