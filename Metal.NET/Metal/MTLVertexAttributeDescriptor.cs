...
/// <summary>An object that determines how to store attribute data in memory and map it to the arguments of a vertex function.</summary>
public class MTLVertexAttributeDescriptor(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLVertexAttributeDescriptor>
{
    ...
    /// <summary>The format of the vertex attribute.</summary>
    ...
    /// <summary>The location of an attribute in vertex data, determined by the byte offset from the start of the vertex data.</summary>
    public nuint Offset
    {
    ...
    /// <summary>The index in the argument table for the associated vertex buffer.</summary>
