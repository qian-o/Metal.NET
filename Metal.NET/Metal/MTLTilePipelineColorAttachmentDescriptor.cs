...
public class MTLTilePipelineColorAttachmentDescriptor(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLTilePipelineColorAttachmentDescriptor>
{
