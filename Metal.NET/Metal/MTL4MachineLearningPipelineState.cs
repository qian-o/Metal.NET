...
/// <summary>A pipeline state that you can use with machine-learning encoder instances.</summary>
public class MTL4MachineLearningPipelineState(nint nativePtr, NativeObjectOwnership ownership) : MTLAllocation(nativePtr, ownership), INativeObject<MTL4MachineLearningPipelineState>
{
    ...
    /// <summary>Returns the device the pipeline state belongs to.</summary>
    public MTLDevice Device
    {
        get => GetProperty(ref field, MTL4MachineLearningPipelineStateBindings.Device);
    }

    /// <summary>Obtain the size of the heap, in bytes, this pipeline requires during the execution.</summary>
    ...
    /// <summary>Queries the string that helps identify this object.</summary>
    public NSString Label
    {
        get => GetProperty(ref field, MTL4MachineLearningPipelineStateBindings.Label);
    }

    /// <summary>Returns reflection information for this machine learning pipeline state.</summary>
