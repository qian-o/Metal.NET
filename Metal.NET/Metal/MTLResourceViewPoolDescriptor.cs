...
/// <summary>Provides parameters for creating a resource view pool.</summary>
public class MTLResourceViewPoolDescriptor(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLResourceViewPoolDescriptor>
{
    ...
    /// <summary>Assigns an optional label you to the resource view pool for debugging purposes.</summary>
    ...
    /// <summary>Configures the number of resource views with which Metal creates the resource view pool.</summary>
