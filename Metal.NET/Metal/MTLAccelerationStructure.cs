...
{
    public static new MTLAccelerationStructure Create(nint nativePtr) => new(nativePtr, true);

    public static new MTLAccelerationStructure CreateBorrowed(nint nativePtr) => new(nativePtr, false);
