...
{
    public static MTLTextureViewDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTLTextureViewDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
