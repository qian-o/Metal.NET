...
public class MTLStencilDescriptor(nint nativePtr, bool ownsReference, bool allowGCRelease = false) : NativeObject(nativePtr, ownsReference, allowGCRelease), INativeObject<MTLStencilDescriptor>
{
    public static MTLStencilDescriptor Null { get; } = new(0, false);

    public static MTLStencilDescriptor Create(nint nativePtr, bool ownsReference) => new(nativePtr, ownsReference);
