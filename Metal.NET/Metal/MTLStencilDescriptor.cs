...
public class MTLStencilDescriptor(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLStencilDescriptor>
{
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTLStencilDescriptorBindings.SetStencilCompareFunction, (nuint)stencilCompareFunction);
    }

    public void SetStencilFailureOperation(MTLStencilOperation stencilFailureOperation)
    {
        ObjectiveC.MsgSend(NativePtr, MTLStencilDescriptorBindings.SetStencilFailureOperation, (nuint)stencilFailureOperation);
    }

    public void SetDepthFailureOperation(MTLStencilOperation depthFailureOperation)
    {
        ObjectiveC.MsgSend(NativePtr, MTLStencilDescriptorBindings.SetDepthFailureOperation, (nuint)depthFailureOperation);
    }

    public void SetDepthStencilPassOperation(MTLStencilOperation depthStencilPassOperation)
    {
        ObjectiveC.MsgSend(NativePtr, MTLStencilDescriptorBindings.SetDepthStencilPassOperation, (nuint)depthStencilPassOperation);
    }

    public void SetReadMask(uint readMask)
    {
        ObjectiveC.MsgSend(NativePtr, MTLStencilDescriptorBindings.SetReadMask, readMask);
    }

    public void SetWriteMask(uint writeMask)
    {
        ObjectiveC.MsgSend(NativePtr, MTLStencilDescriptorBindings.SetWriteMask, writeMask);
    }
}
