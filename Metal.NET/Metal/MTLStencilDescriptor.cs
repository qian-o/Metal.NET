...
public class MTLStencilDescriptor(nint nativePtr, bool retain) : NativeObject(nativePtr, retain)
{
    public MTLStencilDescriptor() : this(ObjectiveCRuntime.AllocInit(MTLStencilDescriptorBindings.Class), false)
    {
    }
