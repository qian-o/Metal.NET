...
public class MTLHeap : IDisposable
{
    ...
    {
        nuint result = (nuint)(ulong)ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLHeapSelector.MaxAvailableSize, (nint)alignment);
    ...
    {
        MTLAccelerationStructure result = new(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLHeapSelector.NewAccelerationStructure, (nint)size));
    ...
    {
        MTLAccelerationStructure result = new(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLHeapSelector.NewAccelerationStructureOffset, (nint)size, (nint)offset));
    ...
    {
        MTLAccelerationStructure result = new(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLHeapSelector.NewAccelerationStructureOffset, descriptor.NativePtr, (nint)offset));
    ...
    {
        MTLBuffer result = new(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLHeapSelector.NewBufferOptions, (nint)length, (nint)options));
    ...
    {
        MTLBuffer result = new(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLHeapSelector.NewBufferOptionsOffset, (nint)length, (nint)options, (nint)offset));
    ...
    {
        MTLTexture result = new(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLHeapSelector.NewTextureOffset, descriptor.NativePtr, (nint)offset));
    ...
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLHeapSelector.SetLabel, label.NativePtr);
    }

    public MTLPurgeableState SetPurgeableState(MTLPurgeableState state)
    {
        MTLPurgeableState result = (MTLPurgeableState)(uint)(ulong)ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLHeapSelector.SetPurgeableState, (nint)(uint)state);
