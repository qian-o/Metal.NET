...
/// <summary>A memory pool from which you can suballocate resources.</summary>
public class MTLHeap(nint nativePtr, NativeObjectOwnership ownership) : MTLAllocation(nativePtr, ownership), INativeObject<MTLHeap>
{
    ...
    /// <summary>A string that identifies the heap.</summary>
    ...
    /// <summary>The total size of the heap, in bytes.</summary>
    public nuint Size
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLHeapBindings.Size);
    }

    /// <summary>The size of all resources currently in the heap, in bytes.</summary>
    public nuint UsedSize
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLHeapBindings.UsedSize);
    }

    /// <summary>The size, in bytes, of the current heap allocation.</summary>
    ...
    /// <summary>Creates a buffer on the heap.</summary>
    ...
    /// <summary>Creates a texture on the heap.</summary>
    ...
    /// <summary>Sets the purgeable state of the heap.</summary>
    ...
    /// <summary>The maximum size of a resource, in bytes, that can be currently allocated from the heap.</summary>
