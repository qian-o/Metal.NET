...
{
    public static MTLFunctionHandle Create(nint nativePtr) => new(nativePtr, true);

    public static MTLFunctionHandle CreateBorrowed(nint nativePtr) => new(nativePtr, false);
