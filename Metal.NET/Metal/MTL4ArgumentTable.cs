...
public class MTL4ArgumentTable : IDisposable
{
    ...
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTL4ArgumentTableSelector.SetAddressBindingIndex, (nint)gpuAddress, (nint)bindingIndex);
    }

    public void SetAddress(uint gpuAddress, uint stride, uint bindingIndex)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTL4ArgumentTableSelector.SetAddressStrideBindingIndex, (nint)gpuAddress, (nint)stride, (nint)bindingIndex);
    }
