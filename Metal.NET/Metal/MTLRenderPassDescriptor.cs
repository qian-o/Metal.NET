...
{
    public static MTLRenderPassDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTLRenderPassDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
