...
{
    public static MTLVertexDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTLVertexDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
