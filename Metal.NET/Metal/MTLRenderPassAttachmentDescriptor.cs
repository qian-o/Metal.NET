...
public class MTLRenderPassAttachmentDescriptor(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLRenderPassAttachmentDescriptor>
{
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderPassAttachmentDescriptorBindings.SetTexture, texture.NativePtr);
    }

    public void SetLevel(nuint level)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderPassAttachmentDescriptorBindings.SetLevel, level);
    }

    public void SetSlice(nuint slice)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderPassAttachmentDescriptorBindings.SetSlice, slice);
    }

    public void SetDepthPlane(nuint depthPlane)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderPassAttachmentDescriptorBindings.SetDepthPlane, depthPlane);
    }

    public void SetResolveTexture(MTLTexture resolveTexture)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderPassAttachmentDescriptorBindings.SetResolveTexture, resolveTexture.NativePtr);
    }

    public void SetResolveLevel(nuint resolveLevel)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderPassAttachmentDescriptorBindings.SetResolveLevel, resolveLevel);
    }

    public void SetResolveSlice(nuint resolveSlice)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderPassAttachmentDescriptorBindings.SetResolveSlice, resolveSlice);
    }

    public void SetResolveDepthPlane(nuint resolveDepthPlane)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderPassAttachmentDescriptorBindings.SetResolveDepthPlane, resolveDepthPlane);
    }

    public void SetLoadAction(MTLLoadAction loadAction)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderPassAttachmentDescriptorBindings.SetLoadAction, (nuint)loadAction);
    }

    public void SetStoreAction(MTLStoreAction storeAction)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderPassAttachmentDescriptorBindings.SetStoreAction, (nuint)storeAction);
    }

    public void SetStoreActionOptions(MTLStoreActionOptions storeActionOptions)
    {
        ObjectiveC.MsgSend(NativePtr, MTLRenderPassAttachmentDescriptorBindings.SetStoreActionOptions, (nuint)storeActionOptions);
    }
}
