...
public class MTL4AccelerationStructureMotionBoundingBoxGeometryDescriptor(nint nativePtr, bool owned) : MTL4AccelerationStructureGeometryDescriptor(nativePtr, owned)
{
