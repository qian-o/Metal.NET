...
/// <summary>Describes motion bounding box geometry, suitable for motion ray tracing.</summary>
public class MTL4AccelerationStructureMotionBoundingBoxGeometryDescriptor(nint nativePtr, NativeObjectOwnership ownership) : MTL4AccelerationStructureGeometryDescriptor(nativePtr, ownership), INativeObject<MTL4AccelerationStructureMotionBoundingBoxGeometryDescriptor>
{
    ...
    /// <summary>Configures a reference to a buffer where each entry contains a reference to a buffer of bounding boxes.</summary>
    ...
    /// <summary>Declares the number of bounding boxes in each buffer that boundingBoxBuffer references.</summary>
    ...
    /// <summary>Declares the stride, in bytes, between bounding boxes in the bounding box buffers each entry in boundingBoxBuffer references.</summary>
