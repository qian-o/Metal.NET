...
{
    public static MTLFunctionConstantValues Create(nint nativePtr) => new(nativePtr, true);

    public static MTLFunctionConstantValues CreateBorrowed(nint nativePtr) => new(nativePtr, false);
