...
/// <summary>A set of constant values that specialize a graphics or compute GPU function.</summary>
public class MTLFunctionConstantValues(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLFunctionConstantValues>
{
    ...
    /// <summary>Sets a value for a function constant at a specific index.</summary>
    ...
    /// <summary>Sets values for a group of function constants within a specific index range.</summary>
    ...
    /// <summary>Deletes all previously set constant values.</summary>
    public void Reset()
    {
