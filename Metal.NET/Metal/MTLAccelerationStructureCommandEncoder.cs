...
{
    public static new MTLAccelerationStructureCommandEncoder Create(nint nativePtr) => new(nativePtr, true);

    public static new MTLAccelerationStructureCommandEncoder CreateBorrowed(nint nativePtr) => new(nativePtr, false);
