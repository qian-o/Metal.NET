...
public class MTLAccelerationStructureCommandEncoder(nint nativePtr, bool ownsReference = true) : MTLCommandEncoder(nativePtr, ownsReference), INativeObject<MTLAccelerationStructureCommandEncoder>
{
    public static new MTLAccelerationStructureCommandEncoder Create(nint nativePtr) => new(nativePtr);

    public static new MTLAccelerationStructureCommandEncoder CreateBorrowed(nint nativePtr) => new(nativePtr, ownsReference: false);
