...
/// <summary>Describes motion curve geometry, suitable for motion ray tracing.</summary>
public class MTL4AccelerationStructureMotionCurveGeometryDescriptor(nint nativePtr, NativeObjectOwnership ownership) : MTL4AccelerationStructureGeometryDescriptor(nativePtr, ownership), INativeObject<MTL4AccelerationStructureMotionCurveGeometryDescriptor>
{
    ...
    /// <summary>Assigns a reference to a buffer where each entry contains a reference to a buffer of control points.</summary>
    ...
    /// <summary>Specifies the number of control points in the buffers the control point buffers reference.</summary>
    ...
    /// <summary>Declares the format of the control points in the buffers that the control point buffers reference.</summary>
    ...
    /// <summary>Sets the stride, in bytes, between control points in the control point buffer.</summary>
    ...
    /// <summary>Sets the curve basis function, determining how Metal interpolates the control points.</summary>
    ...
    /// <summary>Configures the type of curve end caps.</summary>
    ...
    /// <summary>Controls the curve type.</summary>
    ...
    /// <summary>Assigns an optional index buffer containing references to control points in the control point buffers.</summary>
    ...
    /// <summary>Assigns a reference to a buffer containing, in turn, references to curve radii buffers.</summary>
    ...
    /// <summary>Sets the format of the radii in the radius buffer.</summary>
    ...
    /// <summary>Sets the stride, in bytes, between radii in the radius buffer.</summary>
    ...
    /// <summary>Controls the number of control points per curve segment.</summary>
    ...
    /// <summary>Declares the number of curve segments.</summary>
