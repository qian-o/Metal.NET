...
public class MTL4AccelerationStructureMotionCurveGeometryDescriptor(nint nativePtr, NativeObjectOwnership ownership) : MTL4AccelerationStructureGeometryDescriptor(nativePtr, ownership), INativeObject<MTL4AccelerationStructureMotionCurveGeometryDescriptor>
{
    ...
    public void SetControlPointBuffers(MTL4BufferRange controlPointBuffers)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetControlPointBuffers, controlPointBuffers);
    }

    public void SetControlPointCount(nuint controlPointCount)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetControlPointCount, controlPointCount);
    }

    public void SetControlPointStride(nuint controlPointStride)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetControlPointStride, controlPointStride);
    }

    public void SetControlPointFormat(MTLAttributeFormat controlPointFormat)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetControlPointFormat, (nuint)controlPointFormat);
    }

    public void SetRadiusBuffers(MTL4BufferRange radiusBuffers)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetRadiusBuffers, radiusBuffers);
    }

    public void SetRadiusFormat(MTLAttributeFormat radiusFormat)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetRadiusFormat, (nuint)radiusFormat);
    }

    public void SetRadiusStride(nuint radiusStride)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetRadiusStride, radiusStride);
    }

    public void SetIndexBuffer(MTL4BufferRange indexBuffer)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetIndexBuffer, indexBuffer);
    }

    public void SetIndexType(MTLIndexType indexType)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetIndexType, (nuint)indexType);
    }

    public void SetSegmentCount(nuint segmentCount)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetSegmentCount, segmentCount);
    }

    public void SetSegmentControlPointCount(nuint segmentControlPointCount)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetSegmentControlPointCount, segmentControlPointCount);
    }

    public void SetCurveType(MTLCurveType curveType)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetCurveType, (nint)curveType);
    }

    public void SetCurveBasis(MTLCurveBasis curveBasis)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetCurveBasis, (nint)curveBasis);
    }

    public void SetCurveEndCaps(MTLCurveEndCaps curveEndCaps)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4AccelerationStructureMotionCurveGeometryDescriptorBindings.SetCurveEndCaps, (nint)curveEndCaps);
    }
}
