...
public class MTLAccelerationStructureMotionBoundingBoxGeometryDescriptor(nint nativePtr, bool owned) : MTLAccelerationStructureGeometryDescriptor(nativePtr, owned)
{
