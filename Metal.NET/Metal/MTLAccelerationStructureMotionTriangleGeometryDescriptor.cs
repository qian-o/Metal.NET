...
public class MTLAccelerationStructureMotionTriangleGeometryDescriptor(nint nativePtr, bool owned) : MTLAccelerationStructureGeometryDescriptor(nativePtr, owned)
{
