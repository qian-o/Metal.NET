...
{
    public static new MTLResourceStateCommandEncoder Create(nint nativePtr) => new(nativePtr, true);

    public static new MTLResourceStateCommandEncoder CreateBorrowed(nint nativePtr) => new(nativePtr, false);
