...
public class MTLResourceStateCommandEncoder(nint nativePtr, bool ownsReference = true) : MTLCommandEncoder(nativePtr, ownsReference), INativeObject<MTLResourceStateCommandEncoder>
{
    public static new MTLResourceStateCommandEncoder Create(nint nativePtr) => new(nativePtr);

    public static new MTLResourceStateCommandEncoder CreateBorrowed(nint nativePtr) => new(nativePtr, ownsReference: false);
