...
public class MTLInstanceAccelerationStructureDescriptor : IDisposable
{
    ...
    ~MTLInstanceAccelerationStructureDescriptor() => Release();
    ...
    {
        var __r = new MTLInstanceAccelerationStructureDescriptor(ObjectiveCRuntime.intptr_objc_msgSend(s_class, MTLInstanceAccelerationStructureDescriptor_Selectors.descriptor));
        return __r;
    }
