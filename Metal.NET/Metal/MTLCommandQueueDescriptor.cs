...
{
    public static MTLCommandQueueDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTLCommandQueueDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
