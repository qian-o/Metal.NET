...
public class MTLTileRenderPipelineDescriptor(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLTileRenderPipelineDescriptor>
{
    ...
    {
        ObjectiveC.MsgSend(NativePtr, MTLTileRenderPipelineDescriptorBindings.SetLabel, label.NativePtr);
    }

    public void SetTileFunction(MTLFunction tileFunction)
    {
        ObjectiveC.MsgSend(NativePtr, MTLTileRenderPipelineDescriptorBindings.SetTileFunction, tileFunction.NativePtr);
    }

    public void SetRasterSampleCount(nuint rasterSampleCount)
    {
        ObjectiveC.MsgSend(NativePtr, MTLTileRenderPipelineDescriptorBindings.SetRasterSampleCount, rasterSampleCount);
    }

    public void SetThreadgroupSizeMatchesTileSize(bool threadgroupSizeMatchesTileSize)
    {
        ObjectiveC.MsgSend(NativePtr, MTLTileRenderPipelineDescriptorBindings.SetThreadgroupSizeMatchesTileSize, threadgroupSizeMatchesTileSize);
    }

    public void SetMaxTotalThreadsPerThreadgroup(nuint maxTotalThreadsPerThreadgroup)
    {
        ObjectiveC.MsgSend(NativePtr, MTLTileRenderPipelineDescriptorBindings.SetMaxTotalThreadsPerThreadgroup, maxTotalThreadsPerThreadgroup);
    }

    public void SetLinkedFunctions(MTLLinkedFunctions linkedFunctions)
    {
        ObjectiveC.MsgSend(NativePtr, MTLTileRenderPipelineDescriptorBindings.SetLinkedFunctions, linkedFunctions.NativePtr);
    }

    public void SetSupportAddingBinaryFunctions(bool supportAddingBinaryFunctions)
    {
        ObjectiveC.MsgSend(NativePtr, MTLTileRenderPipelineDescriptorBindings.SetSupportAddingBinaryFunctions, supportAddingBinaryFunctions);
    }

    public void SetMaxCallStackDepth(nuint maxCallStackDepth)
    {
        ObjectiveC.MsgSend(NativePtr, MTLTileRenderPipelineDescriptorBindings.SetMaxCallStackDepth, maxCallStackDepth);
    }

    public void SetShaderValidation(MTLShaderValidation shaderValidation)
    {
        ObjectiveC.MsgSend(NativePtr, MTLTileRenderPipelineDescriptorBindings.SetShaderValidation, (nint)shaderValidation);
    }

    public void SetRequiredThreadsPerThreadgroup(MTLSize requiredThreadsPerThreadgroup)
    {
        ObjectiveC.MsgSend(NativePtr, MTLTileRenderPipelineDescriptorBindings.SetRequiredThreadsPerThreadgroup, requiredThreadsPerThreadgroup);
    }
