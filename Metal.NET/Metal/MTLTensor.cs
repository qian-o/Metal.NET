...
/// <summary>A resource representing a multi-dimensional array that you can use with machine learning workloads.</summary>
public class MTLTensor(nint nativePtr, NativeObjectOwnership ownership) : MTLResource(nativePtr, ownership), INativeObject<MTLTensor>
{
    ...
    /// <summary>A buffer instance this tensor shares its storage with or nil if this tensor does not wrap an underlying buffer.</summary>
    public MTLBuffer Buffer
    {
        get => GetProperty(ref field, MTLTensorBindings.Buffer);
    }

    /// <summary>An offset, in bytes, into the buffer instance this tensor shares its storage with, or zero if this tensor does not wrap an underlying buffer.</summary>
    public nuint BufferOffset
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLTensorBindings.BufferOffset);
    }

    /// <summary>An underlying data format of this tensor.</summary>
    public MTLTensorDataType DataType
    {
        get => (MTLTensorDataType)ObjectiveC.MsgSendLong(NativePtr, MTLTensorBindings.DataType);
    }

    /// <summary>An array of sizes, in elements, one for each dimension of this tensor.</summary>
    public MTLTensorExtents Dimensions
    {
        get => GetProperty(ref field, MTLTensorBindings.Dimensions);
    }

    /// <summary>A handle that represents the GPU resource, which you can store in an argument buffer.</summary>
    public MTLResourceID GpuResourceID
    {
        get => ObjectiveC.MsgSendMTLResourceID(NativePtr, MTLTensorBindings.GpuResourceID);
    }

    /// <summary>An array of strides, in elements, one for each dimension of this tensor.</summary>
    public MTLTensorExtents Strides
    {
        get => GetProperty(ref field, MTLTensorBindings.Strides);
    }

    /// <summary>A set of contexts in which you can use this tensor.</summary>
    ...
    /// <summary>Copies the data corresponding to a slice of this tensor into a pointer you provide.</summary>
    ...
    /// <summary>Replaces the contents of a slice of this tensor with data you provide.</summary>
