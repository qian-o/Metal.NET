...
public class MTLResourceStatePassDescriptor : IDisposable
{
    ...
    {
        var result = new MTLResourceStatePassDescriptor(ObjectiveCRuntime.intptr_objc_msgSend(s_class, MTLResourceStatePassDescriptorSelector.ResourceStatePassDescriptor));
