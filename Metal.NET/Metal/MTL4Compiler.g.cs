...
public class MTL4Compiler : IDisposable
{
    ...
    {
        nint errorPtr = 0;
        var result = new MTL4BinaryFunction(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewBinaryFunctionCompilerTaskOptionsError, descriptor.NativePtr, compilerTaskOptions.NativePtr, out errorPtr));
    ...
    {
        nint errorPtr = 0;
        var result = new MTLComputePipelineState(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewComputePipelineStateCompilerTaskOptionsError, descriptor.NativePtr, compilerTaskOptions.NativePtr, out errorPtr));
        error = errorPtr is not 0 ? new NSError(errorPtr) : null;
    ...
    {
        nint errorPtr = 0;
        var result = new MTLComputePipelineState(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewComputePipelineStateDynamicLinkingDescriptorCompilerTaskOptionsError, descriptor.NativePtr, dynamicLinkingDescriptor.NativePtr, compilerTaskOptions.NativePtr, out errorPtr));
        error = errorPtr is not 0 ? new NSError(errorPtr) : null;
    ...
    {
        var result = new MTL4CompilerTask(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewComputePipelineStateOptionsFunction, pDescriptor.NativePtr, options.NativePtr, function));
    ...
    {
        nint errorPtr = 0;
        var result = new MTLDynamicLibrary(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewDynamicLibraryError, library.NativePtr, out errorPtr));
        error = errorPtr is not 0 ? new NSError(errorPtr) : null;
    ...
    {
        nint errorPtr = 0;
        var result = new MTLDynamicLibrary(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewDynamicLibraryError, url.NativePtr, out errorPtr));
        error = errorPtr is not 0 ? new NSError(errorPtr) : null;
    ...
    {
        var result = new MTL4CompilerTask(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewDynamicLibraryFunction, pLibrary.NativePtr, function));
    ...
    {
        var result = new MTL4CompilerTask(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewDynamicLibraryFunction, pURL.NativePtr, function));
    ...
    {
        nint errorPtr = 0;
        var result = new MTLLibrary(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewLibraryError, descriptor.NativePtr, out errorPtr));
        error = errorPtr is not 0 ? new NSError(errorPtr) : null;
    ...
    {
        var result = new MTL4CompilerTask(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewLibraryFunction, pDescriptor.NativePtr, function));
    ...
    {
        nint errorPtr = 0;
        var result = new MTL4MachineLearningPipelineState(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewMachineLearningPipelineStateError, descriptor.NativePtr, out errorPtr));
        error = errorPtr is not 0 ? new NSError(errorPtr) : null;
    ...
    {
        var result = new MTL4CompilerTask(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewMachineLearningPipelineStateFunction, pDescriptor.NativePtr, function));
    ...
    {
        nint errorPtr = 0;
        var result = new MTLRenderPipelineState(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewRenderPipelineStateCompilerTaskOptionsError, descriptor.NativePtr, compilerTaskOptions.NativePtr, out errorPtr));
        error = errorPtr is not 0 ? new NSError(errorPtr) : null;
    ...
    {
        nint errorPtr = 0;
        var result = new MTLRenderPipelineState(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewRenderPipelineStateDynamicLinkingDescriptorCompilerTaskOptionsError, descriptor.NativePtr, dynamicLinkingDescriptor.NativePtr, compilerTaskOptions.NativePtr, out errorPtr));
        error = errorPtr is not 0 ? new NSError(errorPtr) : null;
    ...
    {
        var result = new MTL4CompilerTask(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewRenderPipelineStateOptionsFunction, pDescriptor.NativePtr, options.NativePtr, function));
    ...
    {
        nint errorPtr = 0;
        var result = new MTLRenderPipelineState(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewRenderPipelineStateBySpecializationPipelineError, descriptor.NativePtr, pipeline.NativePtr, out errorPtr));
        error = errorPtr is not 0 ? new NSError(errorPtr) : null;
    ...
    {
        var result = new MTL4CompilerTask(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTL4CompilerSelector.NewRenderPipelineStateBySpecializationPPipelineFunction, pDescriptor.NativePtr, pPipeline.NativePtr, function));
