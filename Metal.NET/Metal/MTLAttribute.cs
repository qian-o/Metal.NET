...
/// <summary>An object that describes an attribute defined in the stage-in argument for a shader.</summary>
public class MTLAttribute(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLAttribute>
{
    ...
    /// <summary>A Boolean value that indicates whether the attribute is active.</summary>
    public Bool8 IsActive
    {
        get => ObjectiveC.MsgSendBool(NativePtr, MTLAttributeBindings.IsActive);
    }

    /// <summary>A Boolean value that indicates whether the attribute represents control point data.</summary>
    public Bool8 IsPatchControlPointData
    {
        get => ObjectiveC.MsgSendBool(NativePtr, MTLAttributeBindings.IsPatchControlPointData);
    }

    /// <summary>A Boolean value that indicates whether the attribute represents tessellation patch data.</summary>
