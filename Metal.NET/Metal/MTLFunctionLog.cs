...
/// <summary>A log entry a Metal device generates when the it runs a command buffer.</summary>
public class MTLFunctionLog(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLFunctionLog>
{
    ...
    /// <summary>The type of message that was logged.</summary>
    ...
    /// <summary>If known, the location of the logging command within a shader source file.</summary>
    public MTLFunctionLogDebugLocation DebugLocation
    {
        get => GetProperty(ref field, MTLFunctionLogBindings.DebugLocation);
    }

    /// <summary>The label for the encoder that logged the message.</summary>
    public NSString EncoderLabel
    {
        get => GetProperty(ref field, MTLFunctionLogBindings.EncoderLabel);
    }

    /// <summary>When known, the function object corresponding to the logged message.</summary>
