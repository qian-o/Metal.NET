...
{
    public static MTLRasterizationRateMap Create(nint nativePtr) => new(nativePtr, true);

    public static MTLRasterizationRateMap CreateBorrowed(nint nativePtr) => new(nativePtr, false);
