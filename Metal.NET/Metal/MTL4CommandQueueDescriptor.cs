...
public class MTL4CommandQueueDescriptor(nint nativePtr, NativeObjectOwnership ownership) : ObjectiveCObject(nativePtr, ownership), INativeObject<MTL4CommandQueueDescriptor>
{
    #region INativeObject
    public static MTL4CommandQueueDescriptor Null { get; } = new(0, NativeObjectOwnership.Borrowed);

    public static MTL4CommandQueueDescriptor New(nint nativePtr, NativeObjectOwnership ownership)
    {
