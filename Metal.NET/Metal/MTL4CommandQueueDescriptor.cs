...
{
    public static MTL4CommandQueueDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTL4CommandQueueDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
