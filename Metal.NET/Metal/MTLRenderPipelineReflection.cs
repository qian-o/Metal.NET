...
/// <summary>Information about the arguments of a graphics function.</summary>
public class MTLRenderPipelineReflection(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLRenderPipelineReflection>
{
    ...
    /// <summary>An array of binding instances, each of which represents a parameter of the pipeline state’s fragment shader.</summary>
    public MTLBinding[] FragmentBindings
    {
        get => GetArrayProperty<MTLBinding>(MTLRenderPipelineReflectionBindings.FragmentBindings);
    }

    /// <summary>An array of binding instances, each of which represents a parameter of the pipeline state’s mesh shader.</summary>
    public MTLBinding[] MeshBindings
    {
        get => GetArrayProperty<MTLBinding>(MTLRenderPipelineReflectionBindings.MeshBindings);
    }

    /// <summary>An array of binding instances, each of which represents a parameter of the pipeline state’s object shader.</summary>
    public MTLBinding[] ObjectBindings
    {
        get => GetArrayProperty<MTLBinding>(MTLRenderPipelineReflectionBindings.ObjectBindings);
    }

    /// <summary>An array of binding instances, each of which represents a parameter of the pipeline state’s tile shader.</summary>
    public MTLBinding[] TileBindings
    {
        get => GetArrayProperty<MTLBinding>(MTLRenderPipelineReflectionBindings.TileBindings);
    }

    /// <summary>An array of binding instances, each of which represents a parameter of the pipeline state’s vertex shader.</summary>
    ...
    /// <summary>An array of argument instances, each of which represent a parameter of the pipeline state’s vertex shader.</summary>
    ...
    /// <summary>An array of argument instances, each of which represent a parameter of the pipeline state’s fragment shader.</summary>
    ...
    /// <summary>An array of argument instances, each of which represent a parameter of the pipeline state’s tile shader.</summary>
