...
{
    public static new MTL4RenderPipelineDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static new MTL4RenderPipelineDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
