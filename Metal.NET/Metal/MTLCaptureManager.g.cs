...
public class MTLCaptureManager : IDisposable
{
    ...
    {
        var result = new MTLCaptureScope(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTLCaptureManagerSelector.NewCaptureScope, device.NativePtr));
    ...
    {
        var result = new MTLCaptureScope(ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTLCaptureManagerSelector.NewCaptureScope, commandQueue.NativePtr));
    ...
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLCaptureManagerSelector.SetDefaultCaptureScope, defaultCaptureScope.NativePtr);
    }

    public Bool8 StartCapture(MTLCaptureDescriptor descriptor, out NSError? error)
    {
        nint errorPtr = 0;
        var result = (byte)ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTLCaptureManagerSelector.StartCaptureError, descriptor.NativePtr, out errorPtr) is not 0;
    ...
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLCaptureManagerSelector.StartCapture, device.NativePtr);
    }

    public void StartCapture(MTLCommandQueue commandQueue)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLCaptureManagerSelector.StartCapture, commandQueue.NativePtr);
    }

    public void StartCapture(MTLCaptureScope captureScope)
    {
        ObjectiveCRuntime.objc_msgSend(NativePtr, MTLCaptureManagerSelector.StartCapture, captureScope.NativePtr);
    }
    ...
    {
        var result = (byte)ObjectiveCRuntime.intptr_objc_msgSend(NativePtr, MTLCaptureManagerSelector.SupportsDestination, (nint)(uint)destination) is not 0;
