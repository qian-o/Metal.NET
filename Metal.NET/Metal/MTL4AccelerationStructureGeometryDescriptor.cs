...
public class MTL4AccelerationStructureGeometryDescriptor(nint nativePtr, bool ownsReference, bool allowGCRelease) : NativeObject(nativePtr, ownsReference, allowGCRelease), INativeObject<MTL4AccelerationStructureGeometryDescriptor>
{
    public static MTL4AccelerationStructureGeometryDescriptor Null { get; } = new(0, false, false);

    public static MTL4AccelerationStructureGeometryDescriptor Create(nint nativePtr, bool ownsReference, bool allowGCRelease) => new(nativePtr, ownsReference, allowGCRelease);

    public MTL4AccelerationStructureGeometryDescriptor() : this(ObjectiveCRuntime.AllocInit(MTL4AccelerationStructureGeometryDescriptorBindings.Class), true, true)
    {
    }
