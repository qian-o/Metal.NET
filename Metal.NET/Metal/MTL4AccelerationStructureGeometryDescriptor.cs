...
/// <summary>Base class for all Metal 4 acceleration structure geometry descriptors.</summary>
public class MTL4AccelerationStructureGeometryDescriptor(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTL4AccelerationStructureGeometryDescriptor>
{
    ...
    /// <summary>A boolean value that indicates whether the ray-tracing system in Metal allows the invocation of intersection functions more than once per ray-primitive intersection.</summary>
    ...
    /// <summary>Sets the offset that this geometry contributes to determining the intersection function to invoke when a ray intersects it.</summary>
    ...
    /// <summary>Assigns an optional label you can assign to this geometry for debugging purposes.</summary>
    ...
    /// <summary>Provides a hint to Metal that this geometry is opaque, potentially accelerating the ray/primitive intersection process.</summary>
    public Bool8 Opaque
    {
    ...
    /// <summary>Assigns optional buffer containing data to associate with each primitive in this geometry.</summary>
    ...
    /// <summary>Sets the size, in bytes, of the data for each primitive in the primitive data buffer  references.</summary>
    ...
    /// <summary>Defines the stride, in bytes, between each primitive’s data in the primitive data buffer  references.</summary>
