...
public class MTL4AccelerationStructureGeometryDescriptor(nint nativePtr, bool ownsReference, bool allowGCRelease = false) : NativeObject(nativePtr, ownsReference, allowGCRelease), INativeObject<MTL4AccelerationStructureGeometryDescriptor>
{
    public static MTL4AccelerationStructureGeometryDescriptor Null { get; } = new(0, false);
