...
public class MTL4BinaryFunctionDescriptor(nint nativePtr, NativeObjectOwnership ownership) : ObjectiveCObject(nativePtr, ownership), INativeObject<MTL4BinaryFunctionDescriptor>
{
    #region INativeObject
    public static MTL4BinaryFunctionDescriptor Null { get; } = new(0, NativeObjectOwnership.Borrowed);

    public static MTL4BinaryFunctionDescriptor New(nint nativePtr, NativeObjectOwnership ownership)
    {
