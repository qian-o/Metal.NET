...
/// <summary>Base interface for other function-derived interfaces.</summary>
public class MTL4BinaryFunctionDescriptor(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTL4BinaryFunctionDescriptor>
{
    ...
    /// <summary>Provides the function descriptor corresponding to the function to compile into a binary function.</summary>
    ...
    /// <summary>Associates a string that uniquely identifies a binary function.</summary>
    ...
    /// <summary>Configure the options to use at binary function creation time.</summary>
