...
{
    public static new MTLIntersectionFunctionDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static new MTLIntersectionFunctionDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
