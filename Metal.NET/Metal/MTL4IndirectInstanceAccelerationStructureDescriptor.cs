...
/// <summary>Descriptor for an “indirect” instance acceleration structure that allows providing the instance count and motion transform count indirectly, through buffer references.</summary>
public class MTL4IndirectInstanceAccelerationStructureDescriptor(nint nativePtr, NativeObjectOwnership ownership) : MTL4AccelerationStructureDescriptor(nativePtr, ownership), INativeObject<MTL4IndirectInstanceAccelerationStructureDescriptor>
{
    ...
    /// <summary>Provides a reference to a buffer containing the number of instances in the instance descriptor buffer, formatted as a 32-bit unsigned integer.</summary>
    ...
    /// <summary>Assigns a reference to a buffer containing instance descriptors for acceleration structures to reference.</summary>
    ...
    /// <summary>Sets the stride, in bytes, between instance descriptors in the instance descriptor buffer.</summary>
    ...
    /// <summary>Controls the type of instance descriptor that the instance descriptor buffer references.</summary>
    ...
    /// <summary>Specifies the layout for the transformation matrices in the instance descriptor buffer and the motion transformation matrix buffer.</summary>
    ...
    /// <summary>Controls the maximum number of instance descriptors the instance descriptor buffer can reference.</summary>
    ...
    /// <summary>Controls the maximum number of motion transforms in the motion transform buffer.</summary>
    ...
    /// <summary>A buffer containing transformation information for instance motion keyframes, formatted according to the motion transform type.</summary>
    ...
    /// <summary>Associates a buffer reference containing the number of motion transforms in the motion transform buffer, formatted as a 32-bit unsigned integer.</summary>
    ...
    /// <summary>Sets the stride for motion transform.</summary>
    ...
    /// <summary>Sets the type of motion transforms, either as a matrix or individual components.</summary>
