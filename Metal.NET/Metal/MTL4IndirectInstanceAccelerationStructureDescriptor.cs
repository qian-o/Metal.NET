...
{
    public static new MTL4IndirectInstanceAccelerationStructureDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static new MTL4IndirectInstanceAccelerationStructureDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
