...
{
    public static MTLResourceViewPool Create(nint nativePtr) => new(nativePtr, true);

    public static MTLResourceViewPool CreateBorrowed(nint nativePtr) => new(nativePtr, false);
