...
public class MTLStructMember : IDisposable
{
    ...
    {
        get => new MTLArrayType(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLStructMemberSelector.ArrayType));
    }

    public MTLDataType DataType
    {
        get => (MTLDataType)(ObjectiveCRuntime.MsgSendUInt(NativePtr, MTLStructMemberSelector.DataType));
    }

    public NSString Name
    {
        get => new NSString(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLStructMemberSelector.Name));
    }
    ...
    {
        get => new MTLPointerType(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLStructMemberSelector.PointerType));
    }

    public MTLStructType StructType
    {
        get => new MTLStructType(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLStructMemberSelector.StructType));
    }

    public MTLTensorReferenceType TensorReferenceType
    {
        get => new MTLTensorReferenceType(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLStructMemberSelector.TensorReferenceType));
    }

    public MTLTextureReferenceType TextureReferenceType
    {
        get => new MTLTextureReferenceType(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLStructMemberSelector.TextureReferenceType));
    }
