...
{
    public static MTLSharedEventListener Create(nint nativePtr) => new(nativePtr, true);

    public static MTLSharedEventListener CreateBorrowed(nint nativePtr) => new(nativePtr, false);
