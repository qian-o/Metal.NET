...
public class MTLIndirectComputeCommand(nint nativePtr, bool ownsReference = true) : NativeObject(nativePtr, ownsReference), INativeObject<MTLIndirectComputeCommand>
{
    public static MTLIndirectComputeCommand Create(nint nativePtr) => new(nativePtr);

    public static MTLIndirectComputeCommand CreateBorrowed(nint nativePtr) => new(nativePtr, ownsReference: false);
