...
/// <summary>A compute command in an indirect command buffer.</summary>
public class MTLIndirectComputeCommand(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLIndirectComputeCommand>
{
    ...
    /// <summary>Sets the command’s compute pipeline state.</summary>
    ...
    /// <summary>Sets the size, in pixels, of the imageblock.</summary>
    ...
    /// <summary>Sets a buffer for the compute function.</summary>
    ...
    /// <summary>Sets the size of a block of threadgroup memory.</summary>
    ...
    /// <summary>Sets the region of the stage-in attributes to apply to the compute kernel.</summary>
    ...
    /// <summary>Adds a barrier to ensure that commands executed prior to this command are complete before this command executes.</summary>
    public void SetBarrier()
    {
        ObjectiveC.MsgSend(NativePtr, MTLIndirectComputeCommandBindings.SetBarrier);
    }

    /// <summary>Removes any barrier set on the command.</summary>
    ...
    /// <summary>Encodes a compute command using a grid aligned to threadgroup boundaries.</summary>
