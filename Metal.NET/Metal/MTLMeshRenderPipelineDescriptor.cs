...
{
    public static MTLMeshRenderPipelineDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTLMeshRenderPipelineDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
