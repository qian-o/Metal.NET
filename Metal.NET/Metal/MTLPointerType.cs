...
{
    public static new MTLPointerType Create(nint nativePtr) => new(nativePtr, true);

    public static new MTLPointerType CreateBorrowed(nint nativePtr) => new(nativePtr, false);
