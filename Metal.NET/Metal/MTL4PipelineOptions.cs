...
{
    public static MTL4PipelineOptions Create(nint nativePtr) => new(nativePtr, true);

    public static MTL4PipelineOptions CreateBorrowed(nint nativePtr) => new(nativePtr, false);
