...
/// <summary>Groups together properties you use to create a mesh render pipeline state object.</summary>
public class MTL4MeshRenderPipelineDescriptor(nint nativePtr, NativeObjectOwnership ownership) : MTL4PipelineDescriptor(nativePtr, ownership), INativeObject<MTL4MeshRenderPipelineDescriptor>
{
    ...
    /// <summary>Sets the logical-to-physical rendering remap state.</summary>
    ...
    /// <summary>Assigns a function descriptor representing the function this pipeline executes for each fragment.</summary>
    ...
    /// <summary>Controls the largest number of threads the pipeline state can execute when the object stage of a mesh render pipeline you create from this descriptor dispatches its mesh stage.</summary>
    ...
    /// <summary>Controls the largest number of threads the pipeline state can execute in a single mesh shader threadgroup dispatch.</summary>
    ...
    /// <summary>Controls the largest number of threads the pipeline state can execute in a single object shader threadgroup dispatch.</summary>
    ...
    /// <summary>Assigns a function descriptor representing the function this pipeline executes for each primitive in the mesh shader stage.</summary>
    ...
    /// <summary>Provides static linking information for the mesh stage of the render pipeline.</summary>
    ...
    /// <summary>Provides a guarantee to Metal regarding the number of threadgroup threads for the mesh stage of a pipeline you create from this descriptor.</summary>
    ...
    /// <summary>Assigns a function descriptor representing the function this pipeline executes for each object in the object shader stage.</summary>
    ...
    /// <summary>Provides static linking information for the object stage of the render pipeline.</summary>
    ...
    /// <summary>Provides a guarantee to Metal regarding the number of threadgroup threads for the object stage of a pipeline you create from this descriptor.</summary>
    ...
    /// <summary>Reserves storage for the object-to-mesh stage payload.</summary>
    ...
    /// <summary>Sets number of samples this pipeline applies for each fragment.</summary>
    ...
    /// <summary>Controls the required number of mesh threads-per-threadgroup when drawing with a mesh shader pipeline you create from this descriptor.</summary>
    ...
    /// <summary>Controls the required number of object threads-per-threadgroup when drawing with a mesh shader pipeline you create from this descriptor.</summary>
    ...
    /// <summary>Indicates whether you can use the render pipeline to create new pipelines by adding binary functions to the fragment shader function’s callable functions list.</summary>
    ...
    /// <summary>Indicates whether you can use the render pipeline to create new pipelines by adding binary functions to the mesh shader function’s callable functions list.</summary>
    ...
    /// <summary>Indicates whether you can use the render pipeline to create new pipelines by adding binary functions to the object shader function’s callable functions list.</summary>
