...
public class MTL4CompilerDescriptor(nint nativePtr, bool retain) : NativeObject(nativePtr, retain)
{
    public MTL4CompilerDescriptor() : this(ObjectiveCRuntime.AllocInit(MTL4CompilerDescriptorBindings.Class), false)
    {
    }
