...
public class MTLArgumentEncoder : IDisposable
{
    ...
    {
        nint result = ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLArgumentEncoderSelector.ConstantData, (nint)index);
    ...
    {
        MTLArgumentEncoder result = new(ObjectiveCRuntime.MsgSendPtr(NativePtr, MTLArgumentEncoderSelector.NewArgumentEncoder, (nint)index));
    ...
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetAccelerationStructureIndex, accelerationStructure.NativePtr, (nint)index);
    }

    public void SetArgumentBuffer(MTLBuffer argumentBuffer, uint offset)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetArgumentBufferOffset, argumentBuffer.NativePtr, (nint)offset);
    }

    public void SetArgumentBuffer(MTLBuffer argumentBuffer, uint startOffset, uint arrayElement)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetArgumentBufferStartOffsetArrayElement, argumentBuffer.NativePtr, (nint)startOffset, (nint)arrayElement);
    }

    public void SetBuffer(MTLBuffer buffer, uint offset, uint index)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetBufferOffsetIndex, buffer.NativePtr, (nint)offset, (nint)index);
    }

    public void SetComputePipelineState(MTLComputePipelineState pipeline, uint index)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetComputePipelineStateIndex, pipeline.NativePtr, (nint)index);
    }

    public void SetDepthStencilState(MTLDepthStencilState depthStencilState, uint index)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetDepthStencilStateIndex, depthStencilState.NativePtr, (nint)index);
    }

    public void SetIndirectCommandBuffer(MTLIndirectCommandBuffer indirectCommandBuffer, uint index)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetIndirectCommandBufferIndex, indirectCommandBuffer.NativePtr, (nint)index);
    }

    public void SetIntersectionFunctionTable(MTLIntersectionFunctionTable intersectionFunctionTable, uint index)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetIntersectionFunctionTableIndex, intersectionFunctionTable.NativePtr, (nint)index);
    }

    public void SetLabel(NSString label)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetLabel, label.NativePtr);
    }

    public void SetRenderPipelineState(MTLRenderPipelineState pipeline, uint index)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetRenderPipelineStateIndex, pipeline.NativePtr, (nint)index);
    }

    public void SetSamplerState(MTLSamplerState sampler, uint index)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetSamplerStateIndex, sampler.NativePtr, (nint)index);
    }

    public void SetTexture(MTLTexture texture, uint index)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetTextureIndex, texture.NativePtr, (nint)index);
    }

    public void SetVisibleFunctionTable(MTLVisibleFunctionTable visibleFunctionTable, uint index)
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTLArgumentEncoderSelector.SetVisibleFunctionTableIndex, visibleFunctionTable.NativePtr, (nint)index);
    }
