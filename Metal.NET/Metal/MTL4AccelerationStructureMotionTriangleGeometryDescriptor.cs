...
public class MTL4AccelerationStructureMotionTriangleGeometryDescriptor(nint nativePtr, bool owned) : MTL4AccelerationStructureGeometryDescriptor(nativePtr, owned)
{
