...
public class MTL4LibraryDescriptor(nint nativePtr, bool ownsReference, bool allowGCRelease) : NativeObject(nativePtr, ownsReference, allowGCRelease), INativeObject<MTL4LibraryDescriptor>
{
    public static MTL4LibraryDescriptor Null { get; } = new(0, false, false);

    public static MTL4LibraryDescriptor Create(nint nativePtr, bool ownsReference, bool allowGCRelease) => new(nativePtr, ownsReference, allowGCRelease);
