...
{
    public static MTL4LibraryDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTL4LibraryDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
