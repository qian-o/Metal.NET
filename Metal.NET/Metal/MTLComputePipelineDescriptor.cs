...
{
    public static MTLComputePipelineDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTLComputePipelineDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
