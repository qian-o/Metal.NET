...
/// <summary>The main Metal interface to a GPU that apps use to draw graphics and run computations in parallel.</summary>
public partial class MTLDevice(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTLDevice>
{
    ...
    /// <summary>The maximum number of concurrent compilation tasks the device is running.</summary>
    ...
    /// <summary>A Boolean value that indicates whether the device uses additional CPU threads for compilation tasks.</summary>
    ...
    /// <summary>The maximum threadgroup memory available to a compute kernel, in bytes.</summary>
    ...
    /// <summary>The maximum number of threads along each dimension of a threadgroup.</summary>
    ...
    /// <summary>A Boolean value that indicates whether the GPU device supports ray tracing.</summary>
    public Bool8 SupportsRaytracing
    {
        get => ObjectiveC.MsgSendBool(NativePtr, MTLDeviceBindings.SupportsRaytracing);
    }

    /// <summary>A Boolean value that indicates whether the GPU device supports motion blur for ray tracing.</summary>
    ...
    /// <summary>A Boolean value that indicates whether you can call ray-tracing functions from a vertex or fragment shader.</summary>
    ...
    /// <summary>A Boolean value that indicates whether the GPU can allocate 32-bit integer texture formats and resolve to 32-bit floating-point texture formats.</summary>
    public Bool8 Supports32BitMSAA
    {
        get => ObjectiveC.MsgSendBool(NativePtr, MTLDeviceBindings.Supports32BitMSAA);
    }

    /// <summary>A Boolean value that indicates whether the GPU can compute multiple interpolations of a fragment function’s input.</summary>
    ...
    /// <summary>A Boolean value that indicates whether the GPU supports barycentric coordinates.</summary>
    ...
    /// <summary>A Boolean value that indicates whether the GPU supports programmable sample positions.</summary>
    ...
    /// <summary>A Boolean value that indicates whether the GPU supports raster order groups.</summary>
    ...
    /// <summary>A Boolean value that indicates whether the GPU can filter a texture with a 32-bit floating-point format.</summary>
    ...
    /// <summary>A Boolean value that indicates whether you can use textures that use BC compression.</summary>
    ...
    /// <summary>A Boolean value that indicates whether a device supports a packed depth-and-stencil pixel format.</summary>
    ...
    /// <summary>A Boolean value that indicates whether you can query the texture level of detail from within a shader.</summary>
    public Bool8 SupportsQueryTextureLOD
    {
        get => ObjectiveC.MsgSendBool(NativePtr, MTLDeviceBindings.SupportsQueryTextureLOD);
    }

    /// <summary>The GPU device’s texture support tier.</summary>
    ...
    /// <summary>A Boolean value that indicates whether the device supports function pointers in compute kernel functions.</summary>
    public Bool8 SupportsFunctionPointers
    {
        get => ObjectiveC.MsgSendBool(NativePtr, MTLDeviceBindings.SupportsFunctionPointers);
    }

    /// <summary>A Boolean value that indicates whether the device supports function pointers in render functions.</summary>
    ...
    /// <summary>The total amount of memory, in bytes, the GPU device is using for all of its resources.</summary>
    public nuint CurrentAllocatedSize
    {
        get => ObjectiveC.MsgSendNUInt(NativePtr, MTLDeviceBindings.CurrentAllocatedSize);
    }

    /// <summary>An approximation of how much memory, in bytes, this GPU device can allocate without affecting its runtime performance.</summary>
    ...
    /// <summary>A Boolean value that indicates whether the GPU shares all of its memory with the CPU.</summary>
    public Bool8 HasUnifiedMemory
    {
        get => ObjectiveC.MsgSendBool(NativePtr, MTLDeviceBindings.HasUnifiedMemory);
    }

    /// <summary>The highest theoretical rate, in bytes per second, the system can copy between system memory and the GPU’s dedicated memory (VRAM).</summary>
    ...
    /// <summary>The counter sets supported by the device object.</summary>
    ...
    /// <summary>The largest amount of memory, in bytes, that a GPU device can allocate to a buffer instance.</summary>
    ...
    /// <summary>Returns the size, in bytes, of a sparse tile the GPU device creates with a specific page size.</summary>
    ...
    /// <summary>Returns the GPU device’s support tier for argument buffers.</summary>
    ...
    /// <summary>The maximum number of unique argument buffer samplers per app.</summary>
    ...
    /// <summary>A Boolean value that indicates whether the GPU device can create and use dynamic libraries in compute pipelines.</summary>
    public Bool8 SupportsDynamicLibraries
    {
        get => ObjectiveC.MsgSendBool(NativePtr, MTLDeviceBindings.SupportsDynamicLibraries);
    }

    /// <summary>A Boolean value that indicates whether the GPU device can create and use dynamic libraries in render pipelines.</summary>
    ...
    /// <summary>Creates a new archive from data available at an NSURL address.</summary>
    ...
    /// <summary>Creates a new argument table from an argument table descriptor.</summary>
    ...
    /// <summary>Creates a new placement sparse buffer of a specific length.</summary>
    ...
    /// <summary>Creates a new command allocator.</summary>
    ...
    /// <summary>Creates a command queue with the provided configuration.</summary>
    ...
    /// <summary>Creates a new compiler from a compiler descriptor.</summary>
    ...
    /// <summary>Creates a new counter heap configured from a counter heap descriptor.</summary>
    ...
    /// <summary>Creates a shader log state with the provided configuration.</summary>
    ...
    /// <summary>Creates a new pipeline data set serializer instance from a descriptor.</summary>
    ...
    /// <summary>Creates a tensor by allocating new memory.</summary>
    ...
    /// <summary>Creates a new texture view pool from a resource view pool descriptor.</summary>
    ...
    /// <summary>Queries the frequency of the GPU timestamp in ticks per second.</summary>
    public ulong QueryTimestampFrequency()
    {
        return ObjectiveC.MsgSendULong(NativePtr, MTLDeviceBindings.QueryTimestampFrequency);
    }

    /// <summary>Returns the size, in bytes, of each entry in a counter heap of a specific counter heap type when your app resolves it into a usable format.</summary>
    ...
    /// <summary>Returns a Boolean value that indicates whether the GPU device supports the feature set of a specific GPU family.</summary>
    ...
    /// <summary>Returns a Boolean value that indicates whether the GPU device supports a specific feature set.</summary>
    [Obsolete]
    ...
    /// <summary>Returns a Boolean value that indicates whether the GPU supports an amplification factor.</summary>
    ...
    /// <summary>Returns a Boolean value that indicates whether you can read GPU counters at the specified command boundary.</summary>
    ...
    /// <summary>Creates a counter sample buffer.</summary>
    ...
    /// <summary>Captures and returns a CPU timestamp and a GPU timestamp from the same moment in time.</summary>
    ...
    /// <summary>Creates a residency set, which can move resources in and out of memory residency.</summary>
    ...
    /// <summary>Creates an input/output command queue you use to submit commands that load assets from the file system into GPU resources or system memory.</summary>
    ...
    /// <summary>Creates an input/output file handle instance that represents a file at a URL.</summary>
    ...
    /// <summary>Creates an indirect command buffer instance.</summary>
    ...
    /// <summary>Synchronously creates a render pipeline state.</summary>
    ...
    /// <summary>Synchronously creates a compute pipeline state and reflection information.</summary>
    ...
    /// <summary>Creates a depth-stencil state instance.</summary>
    ...
    /// <summary>Creates a new GPU heap instance.</summary>
    ...
    /// <summary>Returns the size and alignment, in bytes, of a buffer if you create it from a heap.</summary>
    ...
    /// <summary>Returns the size and alignment, in bytes, of a texture if you create it from a heap.</summary>
    ...
    /// <summary>Creates a new texture instance.</summary>
    ...
    /// <summary>Creates a texture that you can share across process boundaries.</summary>
    ...
    /// <summary>Returns the minimum alignment the GPU device requires to create a linear texture from a buffer.</summary>
    ...
    /// <summary>Returns the minimum alignment the GPU device requires to create a texture buffer from a buffer.</summary>
    ...
    /// <summary>Returns a Boolean value that indicates whether the GPU can sample a texture with a specific number of sample points.</summary>
    ...
    /// <summary>Creates a sampler state instance.</summary>
    ...
    /// <summary>Returns the default sample locations based on the number of samples.</summary>
    ...
    /// <summary>Returns the dimensions of a sparse tile for a texture that has a specific sparse page size.</summary>
    ...
    /// <summary>Converts a list of sparse pixel regions to tile regions.</summary>
    ...
    /// <summary>Converts a list of sparse tile regions to pixel regions.</summary>
    ...
    /// <summary>Creates a new ray-tracing acceleration structure from a descriptor.</summary>
    ...
    /// <summary>Creates a new argument encoder for an array of arguments.</summary>
    ...
    /// <summary>Creates a new memory fence instance.</summary>
    ...
    /// <summary>Creates a new event instance that you can use to synchronize commands and resources within the same GPU device.</summary>
    ...
    /// <summary>Creates a new shared event instance that you can use to synchronize commands and resources across different GPU devices.</summary>
    ...
    /// <summary>Returns a Boolean value that indicates whether the GPU can create a rasterization rate map with a specific number of layers.</summary>
    ...
    /// <summary>Creates a rasterization rate map instance.</summary>
    ...
    /// <summary>Creates a Metal library instance that contains the functions from your app’s default Metal library.</summary>
    ...
    /// <summary>Creates a Metal library instance that contains the functions in the Metal library file at a URL.</summary>
    ...
    /// <summary>Creates a Metal dynamic library instance from a Metal library instance.</summary>
    ...
    /// <summary>Creates a Metal binary archive instance.</summary>
