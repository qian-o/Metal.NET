...
public class MTL4ComputeCommandEncoder(nint nativePtr) : MTL4CommandEncoder(nativePtr)
{
    ...
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTL4ComputeCommandEncoderSelector.CopyFromBufferSourceOffsetToBufferDestinationOffsetSize, sourceBuffer.NativePtr, sourceOffset, destinationBuffer.NativePtr, destinationOffset, size);
    }
    ...
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTL4ComputeCommandEncoderSelector.CopyFromTextureToTexture, sourceTexture.NativePtr, destinationTexture.NativePtr);
    }
    ...
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTL4ComputeCommandEncoderSelector.ExecuteCommandsInBufferWithRange, indirectCommandBuffer.NativePtr, executionRange);
    }
    ...
    {
        ObjectiveCRuntime.MsgSend(NativePtr, MTL4ComputeCommandEncoderSelector.RefitAccelerationStructureDescriptorDestinationScratchBuffer, sourceAccelerationStructure.NativePtr, descriptor.NativePtr, destinationAccelerationStructure.NativePtr, scratchBuffer);
    }
...
file class MTL4ComputeCommandEncoderSelector
{
    ...
    public static readonly Selector RefitAccelerationStructureDescriptorDestinationScratchBuffer = Selector.Register("refitAccelerationStructure:descriptor:destination:scratchBuffer:");
