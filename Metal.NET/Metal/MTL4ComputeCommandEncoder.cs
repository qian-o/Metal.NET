...
public class MTL4ComputeCommandEncoder(nint nativePtr, NativeObjectOwnership ownership) : NSObject(nativePtr, ownership), INativeObject<MTL4ComputeCommandEncoder>
{
    ...
    public void DispatchThreadgroupsWithIndirectBuffer(nuint indirectBuffer, MTLSize threadsPerThreadgroup)
    {
    ...
    public void WriteTimestampWithGranularity(MTL4TimestampGranularity granularity, MTL4CounterHeap counterHeap, nuint index)
    {
