...
/// <summary>Encodes computation dispatches, resource copying commands, and acceleration structure building commands for a single pass into a command buffer.</summary>
public class MTL4ComputeCommandEncoder(nint nativePtr, NativeObjectOwnership ownership) : MTL4CommandEncoder(nativePtr, ownership), INativeObject<MTL4ComputeCommandEncoder>
{
    ...
    /// <summary>Configures this encoder with a compute pipeline state that applies to your subsequent dispatch commands.</summary>
    public void SetComputePipelineState(MTLComputePipelineState state)
    {
        ObjectiveC.MsgSend(NativePtr, MTL4ComputeCommandEncoderBindings.SetComputePipelineState, state.NativePtr);
    }

    /// <summary>Sets an argument table for the compute shader stage of this pipeline.</summary>
    ...
    /// <summary>Configures the size of a threadgroup memory buffer for a threadgroup argument in the compute shader function.</summary>
    ...
    /// <summary>Queries a bitmask representing the shader stages on which commands currently present in this command encoder operate.</summary>
    ...
    /// <summary>Encodes a compute dispatch command using an arbitrarily-sized grid.</summary>
    ...
    /// <summary>Encodes a compute dispatch command with a grid that aligns to threadgroup boundaries.</summary>
    ...
    /// <summary>Encodes a command that copies data from a buffer instance into another.</summary>
    ...
    /// <summary>Encodes a command to copy data from a tensor instance into another.</summary>
    ...
    /// <summary>Encodes a command that copies data from a texture to another.</summary>
    ...
    /// <summary>Encodes a command that copies slices of a texture to slices of another texture.</summary>
    ...
    /// <summary>Encodes a command that generates mipmaps for a texture instance from the base mipmap level up to the highest mipmap level.</summary>
    ...
    /// <summary>Encodes a command that modifies the contents of a texture to improve the performance of CPU accesses to its contents.</summary>
    ...
    /// <summary>Encodes an acceleration structure build into the command buffer.</summary>
    ...
    /// <summary>Encodes a command to copy and compact an acceleration structure.</summary>
    ...
    /// <summary>Encodes an acceleration structure refit operation into the command buffer, providing additional options.</summary>
    ...
    /// <summary>Encodes a command to execute commands from an indirect command buffer.</summary>
    ...
    /// <summary>Writes a GPU timestamp into a heap.</summary>
