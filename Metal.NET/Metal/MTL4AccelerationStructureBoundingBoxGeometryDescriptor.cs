...
public class MTL4AccelerationStructureBoundingBoxGeometryDescriptor(nint nativePtr, bool owned) : MTL4AccelerationStructureGeometryDescriptor(nativePtr, owned)
{
