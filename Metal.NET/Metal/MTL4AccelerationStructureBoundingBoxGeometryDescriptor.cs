...
{
    public static new MTL4AccelerationStructureBoundingBoxGeometryDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static new MTL4AccelerationStructureBoundingBoxGeometryDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
