...
public class MTLTextureDescriptor(nint nativePtr, bool retain) : NativeObject(nativePtr, retain)
{
    public MTLTextureDescriptor() : this(ObjectiveCRuntime.AllocInit(MTLTextureDescriptorBindings.Class), false)
    {
    }
