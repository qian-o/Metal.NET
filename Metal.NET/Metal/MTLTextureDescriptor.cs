...
{
    public static MTLTextureDescriptor Create(nint nativePtr) => new(nativePtr, true);

    public static MTLTextureDescriptor CreateBorrowed(nint nativePtr) => new(nativePtr, false);
