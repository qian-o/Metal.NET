...
/// </summary>
public class NSString(nint nativePtr, bool owned) : NativeObject(nativePtr, owned)
{
    public string Value
    {
    ...
    public static unsafe implicit operator NSString(string value)
    {
        ...
        {
            return new(ObjectiveCRuntime.MsgSendPtr(NSStringBindings.Class, NSStringBindings.StringWithUtf8String, (nint)utf8), false);
        }
    }
