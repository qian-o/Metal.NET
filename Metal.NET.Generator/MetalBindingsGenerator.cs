...
public class MetalBindingsGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(jsonFiles.Collect(), ExecuteJson);
    ...
    private void ExecuteJson(SourceProductionContext ctx,
        ...
        ImmutableArray<(string FileName, string Content)> files)
    {
        ...
        // Step 2: Parse enums from MTL*.hpp files
        ...
        // Step 3: Parse classes/protocols from MTL*.hpp files
